...
main(int argc, char **argv)
{
  ...
  int wakeNUM=wakeall();
  11:	e8 fc 02 00 00       	call   312 <wakeall>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 36f:	f7 f6                	div    %esi
 371:	0f b6 92 18 07 00 00 	movzbl 0x718(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4e8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 4eb:	b8 10 07 00 00       	mov    $0x710,%eax
...
free(void *ap)
{
 ...
 571:	a1 b0 09 00 00       	mov    0x9b0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5c7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5c9:	a3 b0 09 00 00       	mov    %eax,0x9b0
}
 5ce:	5b                   	pop    %ebx
 5cf:	5e                   	pop    %esi
 5d0:	5f                   	pop    %edi
 ...
 5ea:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 5ed:	a3 b0 09 00 00       	mov    %eax,0x9b0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 609:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 60c:	8b 15 b0 09 00 00    	mov    0x9b0,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 65f:	76 3f                	jbe    6a0 <malloc+0xa0>
    ...
    if(p == freep)
 661:	39 05 b0 09 00 00    	cmp    %eax,0x9b0
 ...
 686:	e8 e5 fe ff ff       	call   570 <free>
  return freep;
 68b:	8b 15 b0 09 00 00    	mov    0x9b0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6ac:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6af:	89 15 b0 09 00 00    	mov    %edx,0x9b0
      return (void*)(p + 1);
 ...
 6c4:	eb e9                	jmp    6af <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6c6:	c7 05 b0 09 00 00 b4 	movl   $0x9b4,0x9b0
 6cd:	09 00 00 
 6d0:	c7 05 b4 09 00 00 b4 	movl   $0x9b4,0x9b4
 6d7:	09 00 00 
    base.s.size = 0;
 6da:	b8 b4 09 00 00       	mov    $0x9b4,%eax
 6df:	c7 05 b8 09 00 00 00 	movl   $0x0,0x9b8
 6e6:	00 00 00 
