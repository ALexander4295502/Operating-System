...
main(int argc, char *argv[])
{
  ...
  22:	58                   	pop    %eax
  23:	5a                   	pop    %edx
  24:	68 63 08 00 00       	push   $0x863
  29:	6a 01                	push   $0x1
  2b:	e8 70 04 00 00       	call   4a0 <printf>
  exit();
  30:	e8 0d 03 00 00       	call   342 <exit>
  35:	66 90                	xchg   %ax,%ax
  37:	66 90                	xchg   %ax,%ax
  39:	66 90                	xchg   %ax,%ax
  3b:	66 90                	xchg   %ax,%ax
...
runproctest(void)
{
  ...
  44:	56                   	push   %esi
  45:	53                   	push   %ebx
  46:	83 ec 5c             	sub    $0x5c,%esp
     int fc=fork();
  49:	e8 ec 02 00 00       	call   33a <fork>
     if(fc==0){
  4e:	83 f8 00             	cmp    $0x0,%eax
  51:	0f 85 99 00 00 00    	jne    f0 <runproctest+0xb0>
       char s[80] = "y";
...
runproctest(void)
{
     ...
     if(fc==0){
       char s[80] = "y";
  62:	c7 45 98 79 00 00 00 	movl   $0x79,-0x68(%ebp)
       int answer=0;
  69:	31 f6                	xor    %esi,%esi
void 
runproctest(void)
{
     int fc=fork();
...
if(s[0]=='y'){
  ...
  73:	74 28                	je     9d <runproctest+0x5d>
 fork();
 answer++;
 gets(s,getsmax);
 ...
 printf(1,"there should be %d process runnable, and your answer is %d.\n",answer,runnable());  //if your return value of "runnable()" is same to the answer, your function is passed.
  ...
  77:	74 7e                	je     f7 <runproctest+0xb7>
 break;  //BUG: after you enter n, however the test function will also ADD A RUNNABLE PROCESS AND TEST YOUR "runnable()", which is being corrected.
}else{
 printf(1,"please enter again: \n");
  79:	83 ec 08             	sub    $0x8,%esp
  7c:	68 30 08 00 00       	push   $0x830
  81:	6a 01                	push   $0x1
 ...
 gets(s,getsmax);  
  ...
  8a:	6a 50                	push   $0x50
  8c:	53                   	push   %ebx
  8d:	e8 7e 01 00 00       	call   210 <gets>
     if(fc==0){
       char s[80] = "y";
       int answer=0;
       ...
       while(1){
if(s[0]=='y'){
  92:	0f b6 45 98          	movzbl -0x68(%ebp),%eax
 printf(1,"there should be %d process runnable, and your answer is %d.\n",answer,runnable());  //if your return value of "runnable()" is same to the answer, your function is passed.
}else if(s[0]=='n'){
 break;  //BUG: after you enter n, however the test function will also ADD A RUNNABLE PROCESS AND TEST YOUR "runnable()", which is being corrected.
}else{
 ...
 gets(s,getsmax);  
  96:	83 c4 10             	add    $0x10,%esp
     if(fc==0){
       ...
       while(1){
if(s[0]=='y'){
  99:	3c 79                	cmp    $0x79,%al
  9b:	75 d8                	jne    75 <runproctest+0x35>
  printf(1,"do you want to add a runnable process? (y/n)\n");
  9d:	83 ec 08             	sub    $0x8,%esp
 fork();
 answer++;
  a0:	83 c6 01             	add    $0x1,%esi
       char s[80] = "y";
       int answer=0;
...
if(s[0]=='y'){
  printf(1,"do you want to add a runnable process? (y/n)\n");
  a3:	68 c0 07 00 00       	push   $0x7c0
  a8:	6a 01                	push   $0x1
  aa:	e8 f1 03 00 00       	call   4a0 <printf>
 fork();
  af:	e8 86 02 00 00       	call   33a <fork>
 answer++;
 gets(s,getsmax);
  b4:	59                   	pop    %ecx
  b5:	5f                   	pop    %edi
  b6:	6a 50                	push   $0x50
  b8:	53                   	push   %ebx
  b9:	e8 52 01 00 00       	call   210 <gets>
  be:	83 c4 10             	add    $0x10,%esp
  c1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 while(runnable()==0){} //BUG: it seems that there is sometimes a transition for the state of the process from runnable to sleeping, so we need this loop to avoid this. 
  c8:	e8 1d 03 00 00       	call   3ea <runnable>
  cd:	85 c0                	test   %eax,%eax
  cf:	74 f7                	je     c8 <runproctest+0x88>
 printf(1,"there should be %d process runnable, and your answer is %d.\n",answer,runnable());  //if your return value of "runnable()" is same to the answer, your function is passed.
  d1:	e8 14 03 00 00       	call   3ea <runnable>
  d6:	50                   	push   %eax
  d7:	56                   	push   %esi
  d8:	68 f0 07 00 00       	push   $0x7f0
  dd:	6a 01                	push   $0x1
  df:	e8 bc 03 00 00       	call   4a0 <printf>
  e4:	83 c4 10             	add    $0x10,%esp
  e7:	eb 84                	jmp    6d <runproctest+0x2d>
 ...
 gets(s,getsmax);  
  ...
  f0:	7e 05                	jle    f7 <runproctest+0xb7>
wait();
  f2:	e8 53 02 00 00       	call   34a <wait>
}
...
putc(int fd, char c)
{
 ...
 5b8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5bb:	b8 80 08 00 00       	mov    $0x880,%eax
...
free(void *ap)
{
 ...
 641:	a1 4c 0b 00 00       	mov    0xb4c,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 697:	89 08                	mov    %ecx,(%eax)
  freep = p;
 699:	a3 4c 0b 00 00       	mov    %eax,0xb4c
}
 69e:	5b                   	pop    %ebx
 69f:	5e                   	pop    %esi
 6a0:	5f                   	pop    %edi
 ...
 6ba:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6bd:	a3 4c 0b 00 00       	mov    %eax,0xb4c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 15 4c 0b 00 00    	mov    0xb4c,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 72f:	76 3f                	jbe    770 <malloc+0xa0>
    ...
    if(p == freep)
 731:	39 05 4c 0b 00 00    	cmp    %eax,0xb4c
 ...
 756:	e8 e5 fe ff ff       	call   640 <free>
  return freep;
 75b:	8b 15 4c 0b 00 00    	mov    0xb4c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 77c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 77f:	89 15 4c 0b 00 00    	mov    %edx,0xb4c
      return (void*)(p + 1);
 ...
 794:	eb e9                	jmp    77f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 796:	c7 05 4c 0b 00 00 50 	movl   $0xb50,0xb4c
 79d:	0b 00 00 
 7a0:	c7 05 50 0b 00 00 50 	movl   $0xb50,0xb50
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	b8 50 0b 00 00       	mov    $0xb50,%eax
 7af:	c7 05 54 0b 00 00 00 	movl   $0x0,0xb54
 7b6:	00 00 00 
