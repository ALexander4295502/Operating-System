...
80100055:	e8 96 41 00 00       	call   801041f0 <initlock>
...
bget(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
801000d6:	e8 95 41 00 00       	call   80104270 <acquire>
...
80100116:	e8 85 3d 00 00       	call   80103ea0 <sleep>
...
80100153:	e8 48 42 00 00       	call   801043a0 <release>
bread(uint dev, uint blockno)
{
  struct buf *b;
...
8010017b:	e8 20 42 00 00       	call   801043a0 <release>
...
801001d6:	e8 95 40 00 00       	call   80104270 <acquire>
...
80100210:	e8 2b 3e 00 00       	call   80104040 <wakeup>
...
80100220:	5d                   	pop    %ebp
  ...
  release(&bcache.lock);
80100221:	e9 7a 41 00 00       	jmp    801043a0 <release>
// Move to the head of the MRU list.
void
brelse(struct buf *b)
{
...
8010025e:	e8 0d 40 00 00       	call   80104270 <acquire>
  while(n > 0){
...
80100294:	e8 07 3c 00 00       	call   80103ea0 <sleep>
...
801002e2:	e8 b9 40 00 00       	call   801043a0 <release>
  ilock(ip);
...
801002ff:	e8 9c 40 00 00       	call   801043a0 <release>
        ilock(ip);
...
80100383:	e8 88 3e 00 00       	call   80104210 <getcallerpcs>
  for(i=0; i<10; i++)
    cprintf(" %p", pcs[i]);
...
801003d9:	e8 f2 55 00 00       	call   801059d0 <uartputc>
}
...
80100489:	e8 42 55 00 00       	call   801059d0 <uartputc>
8010048e:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100495:	e8 36 55 00 00       	call   801059d0 <uartputc>
8010049a:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
801004a1:	e8 2a 55 00 00       	call   801059d0 <uartputc>
...
801004cc:	e8 bf 3f 00 00       	call   80104490 <memmove>
    pos -= 80;
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
801004e8:	00 
801004e9:	e8 02 3f 00 00       	call   801043f0 <memset>
...
801005de:	e8 8d 3c 00 00       	call   80104270 <acquire>
...
80100606:	e8 95 3d 00 00       	call   801043a0 <release>
  ilock(ip);
...
801006c3:	e8 d8 3c 00 00       	call   801043a0 <release>
}
...
80100767:	e8 04 3b 00 00       	call   80104270 <acquire>
...
80100795:	e8 d6 3a 00 00       	call   80104270 <acquire>
...
801007f7:	e8 a4 3b 00 00       	call   801043a0 <release>
  if(doprocdump) {
...
8010087d:	a3 84 f7 10 80       	mov    %eax,0x8010f784
          wakeup(&input.r);
80100882:	e8 b9 37 00 00       	call   80104040 <wakeup>
...
801008f6:	5d                   	pop    %ebp
  ...
  if(doprocdump) {
    procdump();  // now call procdump() wo. cons.lock held
801008f7:	e9 24 38 00 00       	jmp    80104120 <procdump>
      }
      break;
    default:
      if(c != 0 && input.e-input.r < INPUT_BUF){
...
80100935:	e8 b6 38 00 00       	call   801041f0 <initlock>
...
801009fa:	75 d5                	jne    801009d1 <exec+0x51>
  ...
  if((pgdir = setupkvm()) == 0)
801009fc:	e8 4f 5e 00 00       	call   80106850 <setupkvm>
...
80100aa2:	e8 49 60 00 00       	call   80106af0 <allocuvm>
...
80100ae3:	e8 48 5f 00 00       	call   80106a30 <loaduvm>
...
80100af9:	e8 02 61 00 00       	call   80106c00 <freevm>
...
80100b39:	e8 b2 5f 00 00       	call   80106af0 <allocuvm>
...
80100b51:	e8 aa 60 00 00       	call   80106c00 <freevm>
  if(ip){
    iunlockput(ip);
    end_op();
  }
...
80100b7a:	e8 01 61 00 00       	call   80106c80 <clearpteu>
  sp = sz;
...
80100bb1:	e8 5a 3a 00 00       	call   80104610 <strlen>
...
80100bc2:	e8 49 3a 00 00       	call   80104610 <strlen>
...
80100be1:	e8 fa 61 00 00       	call   80106de0 <copyout>
...
80100c4c:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c52:	e8 89 61 00 00       	call   80106de0 <copyout>
...
80100c9d:	e8 2e 39 00 00       	call   801045d0 <safestrcpy>
...
80100cd7:	e8 34 5c 00 00       	call   80106910 <switchuvm>
  freevm(oldpgdir);
80100cdc:	89 34 24             	mov    %esi,(%esp)
80100cdf:	e8 1c 5f 00 00       	call   80106c00 <freevm>
  return 0;
...
80100d25:	e8 c6 34 00 00       	call   801041f0 <initlock>
}
80100d2a:	c9                   	leave  
80100d2b:	c3                   	ret    
...
80100d43:	e8 28 35 00 00       	call   80104270 <acquire>
...
80100d69:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100d70:	e8 2b 36 00 00       	call   801043a0 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100d87:	e8 14 36 00 00       	call   801043a0 <release>
  return 0;
}
...
80100db1:	e8 ba 34 00 00       	call   80104270 <acquire>
  if(f->ref < 1)
...
80100dca:	e8 d1 35 00 00       	call   801043a0 <release>
  return f;
}
...
80100e03:	e8 68 34 00 00       	call   80104270 <acquire>
  if(f->ref < 1)
...
80100e2a:	5d                   	pop    %ebp
  ...
  if(--f->ref > 0){
    release(&ftable.lock);
80100e2b:	e9 70 35 00 00       	jmp    801043a0 <release>
    return;
  }
  ff = *f;
...
80100e4c:	89 45 e0             	mov    %eax,-0x20(%ebp)
  ...
  f->type = FD_NONE;
  release(&ftable.lock);
80100e4f:	e8 4c 35 00 00       	call   801043a0 <release>
...
801011b8:	e8 33 32 00 00       	call   801043f0 <memset>
  log_write(bp);
...
801011f9:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  ...
  acquire(&icache.lock);
801011fc:	e8 6f 30 00 00       	call   80104270 <acquire>
...
80101233:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
80101236:	e8 65 31 00 00       	call   801043a0 <release>
  ip->ref = 1;
  ip->flags = 0;
  release(&icache.lock);
...
80101276:	e8 25 31 00 00       	call   801043a0 <release>
...
80101382:	e8 09 31 00 00       	call   80104490 <memmove>
  brelse(bp);
...
80101445:	e8 a6 2d 00 00       	call   801041f0 <initlock>
  readsb(dev, &sb);
...
80101539:	e8 b2 2e 00 00       	call   801043f0 <memset>
      dip->type = type;
...
801015ef:	00 
801015f0:	e8 9b 2e 00 00       	call   80104490 <memmove>
  log_write(bp);
...
80101621:	e8 4a 2c 00 00       	call   80104270 <acquire>
  ip->ref++;
80101626:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010162a:	c7 04 24 c0 01 11 80 	movl   $0x801101c0,(%esp)
80101631:	e8 6a 2d 00 00       	call   801043a0 <release>
  return ip;
}
...
80101665:	e8 06 2c 00 00       	call   80104270 <acquire>
...
80101683:	e8 18 28 00 00       	call   80103ea0 <sleep>
...
8010169c:	e8 ff 2c 00 00       	call   801043a0 <release>
...
80101713:	e8 78 2d 00 00       	call   80104490 <memmove>
    brelse(bp);
...
80101772:	e8 f9 2a 00 00       	call   80104270 <acquire>
  ip->flags &= ~I_BUSY;
80101777:	83 63 0c fe          	andl   $0xfffffffe,0xc(%ebx)
  wakeup(ip);
8010177b:	89 1c 24             	mov    %ebx,(%esp)
8010177e:	e8 bd 28 00 00       	call   80104040 <wakeup>
  release(&icache.lock);
...
8010178e:	5d                   	pop    %ebp
  ...
  wakeup(ip);
  release(&icache.lock);
8010178f:	e9 0c 2c 00 00       	jmp    801043a0 <release>
// Unlock the given inode.
void
iunlock(struct inode *ip)
{
...
801017b3:	e8 b8 2a 00 00       	call   80104270 <acquire>
...
801017f6:	e8 a5 2b 00 00       	call   801043a0 <release>
...
8010184e:	e8 1d 2a 00 00       	call   80104270 <acquire>
    ip->flags = 0;
80101853:	c7 46 0c 00 00 00 00 	movl   $0x0,0xc(%esi)
    wakeup(ip);
8010185a:	89 34 24             	mov    %esi,(%esp)
8010185d:	e8 de 27 00 00       	call   80104040 <wakeup>
...
80101878:	5d                   	pop    %ebp
  ...
  ip->ref--;
  release(&icache.lock);
80101879:	e9 22 2b 00 00       	jmp    801043a0 <release>
...
801019e8:	e8 a3 2a 00 00       	call   80104490 <memmove>
    brelse(bp);
...
80101ae4:	e8 a7 29 00 00       	call   80104490 <memmove>
    log_write(bp);
...
80101b8b:	e8 80 29 00 00       	call   80104510 <strncmp>
}
80101b90:	c9                   	leave  
80101b91:	c3                   	ret    
...
80101c09:	e8 02 29 00 00       	call   80104510 <strncmp>
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlink read");
    if(de.inum == 0)
...
80101c89:	e8 e2 25 00 00       	call   80104270 <acquire>
  ip->ref++;
80101c8e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101c92:	c7 04 24 c0 01 11 80 	movl   $0x801101c0,(%esp)
80101c99:	e8 02 27 00 00       	call   801043a0 <release>
...
80101cfb:	e8 90 27 00 00       	call   80104490 <memmove>
    path++;
  if(*path == 0)
    return 0;
  s = path;
...
80101d89:	e8 02 27 00 00       	call   80104490 <memmove>
    name[len] = 0;
...
80101e83:	e8 f8 26 00 00       	call   80104580 <strncpy>
  de.inum = inum;
...
80101ff5:	e8 f6 21 00 00       	call   801041f0 <initlock>
  picenable(IRQ_IDE);
...
80102080:	e8 eb 21 00 00       	call   80104270 <acquire>
  if((b = idequeue) == 0){
...
801020ac:	e8 8f 1f 00 00       	call   80104040 <wakeup>
...
801020c6:	e8 d5 22 00 00       	call   801043a0 <release>
  // Start disk on next buf in queue.
  if(idequeue != 0)
    idestart(idequeue);
...
8010214b:	e8 20 21 00 00       	call   80104270 <acquire>
...
80102193:	e8 08 1d 00 00       	call   80103ea0 <sleep>
  // Start disk if necessary.
  if(idequeue == b)
    idestart(b);
...
801021ad:	5d                   	pop    %ebp
  ...
  release(&idelock);
801021ae:	e9 ed 21 00 00       	jmp    801043a0 <release>
...
8010231a:	e8 d1 20 00 00       	call   801043f0 <memset>
...
80102353:	5d                   	pop    %ebp
  ...
  if(kmem.use_lock)
    release(&kmem.lock);
80102354:	e9 47 20 00 00       	jmp    801043a0 <release>
...
80102367:	e8 04 1f 00 00       	call   80104270 <acquire>
...
801023ea:	e8 01 1e 00 00       	call   801041f0 <initlock>
...
801024bd:	e8 de 1e 00 00       	call   801043a0 <release>
  return (char*)r;
}
...
801024d7:	e8 94 1d 00 00       	call   80104270 <acquire>
...
8010290c:	e8 2f 1b 00 00       	call   80104440 <memcmp>
...
80102a37:	e8 54 1a 00 00       	call   80104490 <memmove>
...
80102afa:	e8 f1 16 00 00       	call   801041f0 <initlock>
  readsb(dev, &sb);
...
80102b8d:	e8 de 16 00 00       	call   80104270 <acquire>
...
80102ba7:	e8 f4 12 00 00       	call   80103ea0 <sleep>
void
begin_op(void)
{
  acquire(&log.lock);
...
80102bd5:	a3 1c 12 11 80       	mov    %eax,0x8011121c
      release(&log.lock);
80102bda:	e8 c1 17 00 00       	call   801043a0 <release>
      break;
    }
  }
}
...
80102c00:	e8 6b 16 00 00       	call   80104270 <acquire>
  log.outstanding -= 1;
...
80102c38:	00 00 00 
  ...
  release(&log.lock);
80102c3b:	e8 60 17 00 00       	call   801043a0 <release>
}
...
80102c9f:	e8 ec 17 00 00       	call   80104490 <memmove>
...
80102d5d:	e8 0e 15 00 00       	call   80104270 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102dae:	5d                   	pop    %ebp
  ...
  b->flags |= B_DIRTY; // prevent eviction
  release(&log.lock);
80102daf:	e9 ec 15 00 00       	jmp    801043a0 <release>
...
80102ef3:	e8 98 15 00 00       	call   80104490 <memmove>
...
80102fdb:	e8 60 14 00 00       	call   80104440 <memcmp>
...
80103096:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
80103099:	e8 a2 13 00 00       	call   80104440 <memcmp>
...
80103326:	80 
80103327:	e8 c4 0e 00 00       	call   801041f0 <initlock>
  (*f0)->type = FD_PIPE;
...
801033b1:	e8 ba 0e 00 00       	call   80104270 <acquire>
  if(writable){
...
801033cd:	e8 6e 0c 00 00       	call   80104040 <wakeup>
  } else {
    p->readopen = 0;
    wakeup(&p->nwrite);
  }
...
801033ee:	5d                   	pop    %ebp
  ...
  if(p->readopen == 0 && p->writeopen == 0){
    ...
    release(&p->lock);
801033ef:	e9 ac 0f 00 00       	jmp    801043a0 <release>
...
8010340b:	e8 30 0c 00 00       	call   80104040 <wakeup>
...
8010341b:	e8 80 0f 00 00       	call   801043a0 <release>
    kfree((char*)p);
...
8010343f:	e8 2c 0e 00 00       	call   80104270 <acquire>
  for(i = 0; i < n; i++){
...
801034c2:	e8 79 0b 00 00       	call   80104040 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
801034c7:	89 7c 24 04          	mov    %edi,0x4(%esp)
801034cb:	89 1c 24             	mov    %ebx,(%esp)
801034ce:	e8 cd 09 00 00       	call   80103ea0 <sleep>
{
  int i;
...
8010351a:	e8 21 0b 00 00       	call   80104040 <wakeup>
  release(&p->lock);
8010351f:	89 3c 24             	mov    %edi,(%esp)
80103522:	e8 79 0e 00 00       	call   801043a0 <release>
  return n;
...
80103533:	e8 68 0e 00 00       	call   801043a0 <release>
        return -1;
...
80103562:	e8 09 0d 00 00       	call   80104270 <acquire>
...
8010358f:	e8 0c 09 00 00       	call   80103ea0 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
801035bc:	e8 df 0d 00 00       	call   801043a0 <release>
...
80103615:	e8 26 0a 00 00       	call   80104040 <wakeup>
  release(&p->lock);
8010361a:	89 34 24             	mov    %esi,(%esp)
8010361d:	e8 7e 0d 00 00       	call   801043a0 <release>
  return i;
}
...
80103681:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103684:	c7 40 14 50 56 10 80 	movl   $0x80105650,0x14(%eax)
...
8010369e:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
801036a1:	e8 4a 0d 00 00       	call   801043f0 <memset>
...
801036dd:	e8 be 0c 00 00       	call   801043a0 <release>
...
80103735:	e8 b6 0a 00 00       	call   801041f0 <initlock>
}
8010373a:	c9                   	leave  
8010373b:	c3                   	ret    
...
8010374e:	e8 1d 0b 00 00       	call   80104270 <acquire>
...
8010375f:	e8 ec 30 00 00       	call   80106850 <setupkvm>
...
80103781:	80 
80103782:	e8 29 32 00 00       	call   801069b0 <inituvm>
  p->sz = PGSIZE;
...
801037a3:	e8 48 0c 00 00       	call   801043f0 <memset>
...
8010380a:	e8 c1 0d 00 00       	call   801045d0 <safestrcpy>
  p->cwd = namei("/");
...
8010382c:	e8 6f 0b 00 00       	call   801043a0 <release>
}
...
80103877:	e8 74 32 00 00       	call   80106af0 <allocuvm>
...
80103892:	e8 79 30 00 00       	call   80106910 <switchuvm>
  return 0;
...
801038b2:	e8 29 33 00 00       	call   80106be0 <deallocuvm>
...
801038e0:	e8 8b 09 00 00       	call   80104270 <acquire>
...
80103906:	e8 a5 33 00 00       	call   80106cb0 <copyuvm>
...
8010399c:	e8 2f 0c 00 00       	call   801045d0 <safestrcpy>
...
801039b2:	e8 e9 09 00 00       	call   801043a0 <release>
...
801039e1:	e8 ba 09 00 00       	call   801043a0 <release>
    return -1;
...
80103a00:	bb 14 19 11 80       	mov    $0x80111914,%ebx
  for(;;){
    ...
    // Loop over process table looking for process to run.
    acquire(&ptable.lock);
80103a05:	e8 66 08 00 00       	call   80104270 <acquire>
...
80103a2b:	83 c3 7c             	add    $0x7c,%ebx
      ...
      proc = p;
      switchuvm(p);
80103a2e:	e8 dd 2e 00 00       	call   80106910 <switchuvm>
      p->state = RUNNING;
...
80103a4d:	e8 da 0b 00 00       	call   8010462c <swtch>
      switchkvm();
80103a52:	e8 99 2e 00 00       	call   801068f0 <switchkvm>
    // Enable interrupts on this processor.
    sti();
...
80103a77:	e8 24 09 00 00       	call   801043a0 <release>
...
80103aa0:	e8 cb 07 00 00       	call   80104270 <acquire>
 for(p = ptable.proc; p<&ptable.proc[NPROC];p++) {
...
80103add:	e8 be 08 00 00       	call   801043a0 <release>
...
80103b1d:	e8 4e 07 00 00       	call   80104270 <acquire>
...
80103b79:	75 7e                	jne    80103bf9 <translate+0x109>
 pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
 cprintf("get pgtab!!!!!!!!!!!!!\n");
80103b7b:	c7 04 24 5a 74 10 80 	movl   $0x8010745a,(%esp)
// cprintf("get pgdir!!!!!!!!!!!!!!!\n");
 cprintf("page directory base is: %p\n",pgdir);
 pde = &pgdir[PDX(vaddr)];
// cprintf("get pde!!!!!!!!!!!!!!!\n");
 if((*pde & PTE_P)&&(*pde & PTE_U)){
 pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80103b82:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
 cprintf("get pgtab!!!!!!!!!!!!!\n");
80103b88:	e8 93 ca ff ff       	call   80100620 <cprintf>
 cprintf("pde = %d\n",*pde);
 cprintf("PTE_P = %d\n",PTE_P);
...
80103b90:	c1 e8 0c             	shr    $0xc,%eax
80103b93:	25 ff 03 00 00       	and    $0x3ff,%eax
// cprintf("get pte!!!!!!!!!!!!!\n");
 if((*pte & PTE_U)&&(*pte & PTE_P)){
80103b98:	8b 84 83 00 00 00 80 	mov    -0x80000000(%ebx,%eax,4),%eax
80103b9f:	89 c2                	mov    %eax,%edx
80103ba1:	83 e2 05             	and    $0x5,%edx
80103ba4:	83 fa 05             	cmp    $0x5,%edx
80103ba7:	74 3b                	je     80103be4 <translate+0xf4>
...
80103bab:	8b 45 08             	mov    0x8(%ebp),%eax
80103bae:	c7 04 24 b1 74 10 80 	movl   $0x801074b1,(%esp)
80103bb5:	89 44 24 04          	mov    %eax,0x4(%esp)
80103bb9:	e8 62 ca ff ff       	call   80100620 <cprintf>
  cprintf("the physical address is %d\n",paddr);
80103bbe:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80103bc2:	c7 04 24 cc 74 10 80 	movl   $0x801074cc,(%esp)
80103bc9:	e8 52 ca ff ff       	call   80100620 <cprintf>
 // }else{
 // cprintf("the paddr of the pointer is %d\n",paddr);
 // }
 release(&ptable.lock);
80103bce:	c7 04 24 e0 18 11 80 	movl   $0x801118e0,(%esp)
80103bd5:	e8 c6 07 00 00       	call   801043a0 <release>
  return 0;

}
80103bda:	83 c4 1c             	add    $0x1c,%esp
  cprintf("the physical address is %d\n",paddr);
 // }else{
 // cprintf("the paddr of the pointer is %d\n",paddr);
 // }
...
// cprintf("get pte!!!!!!!!!!!!!\n");
 if((*pte & PTE_U)&&(*pte & PTE_P)){
 paddr = PTE_ADDR(*pte); 
80103be4:	25 00 f0 ff ff       	and    $0xfffff000,%eax
 cprintf("get paddr!!!!!!!!!!!!!\n");
80103be9:	c7 04 24 99 74 10 80 	movl   $0x80107499,(%esp)
 return -1;
 }
 pte = &pgtab[PTX(vaddr)];
// cprintf("get pte!!!!!!!!!!!!!\n");
...
80103bf0:	89 c3                	mov    %eax,%ebx
 cprintf("get paddr!!!!!!!!!!!!!\n");
80103bf2:	e8 29 ca ff ff       	call   80100620 <cprintf>
80103bf7:	eb b2                	jmp    80103bab <translate+0xbb>
// cprintf("get pde!!!!!!!!!!!!!!!\n");
 if((*pde & PTE_P)&&(*pde & PTE_U)){
 pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
 cprintf("get pgtab!!!!!!!!!!!!!\n");
 ...
 cprintf("pde = %d\n",*pde);
80103bf9:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80103bfd:	c7 04 24 72 74 10 80 	movl   $0x80107472,(%esp)
80103c04:	e8 17 ca ff ff       	call   80100620 <cprintf>
 cprintf("PTE_P = %d\n",PTE_P);
80103c09:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80103c10:	00 
80103c11:	c7 04 24 7c 74 10 80 	movl   $0x8010747c,(%esp)
80103c18:	e8 03 ca ff ff       	call   80100620 <cprintf>
 cprintf("pte not present\n");
80103c1d:	c7 04 24 88 74 10 80 	movl   $0x80107488,(%esp)
80103c24:	e8 f7 c9 ff ff       	call   80100620 <cprintf>
 // cprintf("the paddr of the pointer is %d\n",paddr);
 // }
 release(&ptable.lock);
  return 0;
...
80103c29:	83 c4 1c             	add    $0x1c,%esp
 cprintf("get pgtab!!!!!!!!!!!!!\n");
 }else{
 cprintf("pde = %d\n",*pde);
 cprintf("PTE_P = %d\n",PTE_P);
 cprintf("pte not present\n");
 return -1;
80103c2c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 // cprintf("the paddr of the pointer is %d\n",paddr);
 // }
 release(&ptable.lock);
  return 0;
...
int runnable(void)
{
80103c46:	83 ec 14             	sub    $0x14,%esp
   // //  p->state = RUNNABLE;
   //   }
   // }
   // release(&ptable.lock);
    ...
    acquire(&ptable.lock);
80103c49:	c7 04 24 e0 18 11 80 	movl   $0x801118e0,(%esp)
80103c50:	e8 1b 06 00 00       	call   80104270 <acquire>
    for(p = ptable.proc; p< &ptable.proc[NPROC]; p++){
80103c55:	ba 14 19 11 80       	mov    $0x80111914,%edx
80103c5a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->state == RUNNABLE){
      runbleNUM++;
80103c60:	31 c0                	xor    %eax,%eax
80103c62:	83 7a 0c 03          	cmpl   $0x3,0xc(%edx)
80103c66:	0f 94 c0             	sete   %al
   //   }
   // }
   // release(&ptable.lock);
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p< &ptable.proc[NPROC]; p++){
80103c69:	83 c2 7c             	add    $0x7c,%edx
      if(p->state == RUNNABLE){
      runbleNUM++;
80103c6c:	01 c3                	add    %eax,%ebx
   //   }
   // }
   // release(&ptable.lock);
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p< &ptable.proc[NPROC]; p++){
80103c6e:	81 fa 14 38 11 80    	cmp    $0x80113814,%edx
80103c74:	75 ea                	jne    80103c60 <runnable+0x20>
      runningNUM++;
    ...
    release(&ptable.lock);
80103c76:	c7 04 24 e0 18 11 80 	movl   $0x801118e0,(%esp)
80103c7d:	e8 1e 07 00 00       	call   801043a0 <release>
...
80103c82:	83 c4 14             	add    $0x14,%esp
...
80103c97:	c7 04 24 e0 18 11 80 	movl   $0x801118e0,(%esp)
80103c9e:	e8 5d 06 00 00       	call   80104300 <holding>
80103ca3:	85 c0                	test   %eax,%eax
80103ca5:	74 4d                	je     80103cf4 <sched+0x64>
    panic("sched ptable.lock");
  if(cpu->ncli != 1)
80103ca7:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80103cad:	83 b8 ac 00 00 00 01 	cmpl   $0x1,0xac(%eax)
80103cb4:	75 62                	jne    80103d18 <sched+0x88>
    panic("sched locks");
  if(proc->state == RUNNING)
80103cb6:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80103cbd:	83 7a 0c 04          	cmpl   $0x4,0xc(%edx)
80103cc1:	74 49                	je     80103d0c <sched+0x7c>
...
80103cc4:	59                   	pop    %ecx
    panic("sched running");
  if(readeflags()&FL_IF)
80103cc5:	80 e5 02             	and    $0x2,%ch
80103cc8:	75 36                	jne    80103d00 <sched+0x70>
    panic("sched interruptible");
  intena = cpu->intena;
80103cca:	8b 98 b0 00 00 00    	mov    0xb0(%eax),%ebx
  swtch(&proc->context, cpu->scheduler);
80103cd0:	83 c2 1c             	add    $0x1c,%edx
80103cd3:	8b 40 04             	mov    0x4(%eax),%eax
80103cd6:	89 14 24             	mov    %edx,(%esp)
80103cd9:	89 44 24 04          	mov    %eax,0x4(%esp)
80103cdd:	e8 4a 09 00 00       	call   8010462c <swtch>
  cpu->intena = intena;
80103ce2:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80103ce8:	89 98 b0 00 00 00    	mov    %ebx,0xb0(%eax)
}
...
sched(void)
{
  ...
  if(!holding(&ptable.lock))
    panic("sched ptable.lock");
80103cf4:	c7 04 24 e8 74 10 80 	movl   $0x801074e8,(%esp)
80103cfb:	e8 30 c6 ff ff       	call   80100330 <panic>
  if(cpu->ncli != 1)
    panic("sched locks");
  if(proc->state == RUNNING)
    panic("sched running");
  if(readeflags()&FL_IF)
    panic("sched interruptible");
80103d00:	c7 04 24 14 75 10 80 	movl   $0x80107514,(%esp)
80103d07:	e8 24 c6 ff ff       	call   80100330 <panic>
  if(!holding(&ptable.lock))
    panic("sched ptable.lock");
  if(cpu->ncli != 1)
    panic("sched locks");
  if(proc->state == RUNNING)
    panic("sched running");
80103d0c:	c7 04 24 06 75 10 80 	movl   $0x80107506,(%esp)
80103d13:	e8 18 c6 ff ff       	call   80100330 <panic>
  int intena;
  ...
  if(cpu->ncli != 1)
    panic("sched locks");
80103d18:	c7 04 24 fa 74 10 80 	movl   $0x801074fa,(%esp)
80103d1f:	e8 0c c6 ff ff       	call   80100330 <panic>
...
80103d37:	83 ec 10             	sub    $0x10,%esp
  ...
  if(proc == initproc)
80103d3a:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80103d41:	3b 15 bc a5 10 80    	cmp    0x8010a5bc,%edx
80103d47:	0f 84 01 01 00 00    	je     80103e4e <exit+0x11e>
80103d4d:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(proc->ofile[fd]){
80103d50:	8d 73 08             	lea    0x8(%ebx),%esi
80103d53:	8b 44 b2 08          	mov    0x8(%edx,%esi,4),%eax
80103d57:	85 c0                	test   %eax,%eax
80103d59:	74 17                	je     80103d72 <exit+0x42>
      fileclose(proc->ofile[fd]);
80103d5b:	89 04 24             	mov    %eax,(%esp)
80103d5e:	e8 8d d0 ff ff       	call   80100df0 <fileclose>
      proc->ofile[fd] = 0;
80103d63:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80103d6a:	c7 44 b2 08 00 00 00 	movl   $0x0,0x8(%edx,%esi,4)
80103d71:	00 
  ...
  // Close all open files.
  for(fd = 0; fd < NOFILE; fd++){
80103d72:	83 c3 01             	add    $0x1,%ebx
80103d75:	83 fb 10             	cmp    $0x10,%ebx
80103d78:	75 d6                	jne    80103d50 <exit+0x20>
      fileclose(proc->ofile[fd]);
      proc->ofile[fd] = 0;
    }
  }
  ...
  begin_op();
80103d7a:	e8 01 ee ff ff       	call   80102b80 <begin_op>
  iput(proc->cwd);
80103d7f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80103d85:	8b 40 68             	mov    0x68(%eax),%eax
80103d88:	89 04 24             	mov    %eax,(%esp)
80103d8b:	e8 10 da ff ff       	call   801017a0 <iput>
  end_op();
80103d90:	e8 5b ee ff ff       	call   80102bf0 <end_op>
  proc->cwd = 0;
80103d95:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80103d9b:	c7 40 68 00 00 00 00 	movl   $0x0,0x68(%eax)

  acquire(&ptable.lock);
80103da2:	c7 04 24 e0 18 11 80 	movl   $0x801118e0,(%esp)
80103da9:	e8 c2 04 00 00       	call   80104270 <acquire>

  // Parent might be sleeping in wait().
  wakeup1(proc->parent);
80103dae:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
static void
wakeup1(void *chan)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103db5:	b8 14 19 11 80       	mov    $0x80111914,%eax
  proc->cwd = 0;
  ...
  // Parent might be sleeping in wait().
  wakeup1(proc->parent);
80103dba:	8b 51 14             	mov    0x14(%ecx),%edx
80103dbd:	eb 0b                	jmp    80103dca <exit+0x9a>
80103dbf:	90                   	nop
static void
wakeup1(void *chan)
{
...
80103dc8:	74 1c                	je     80103de6 <exit+0xb6>
    if(p->state == SLEEPING && p->chan == chan)
80103dca:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103dce:	75 f0                	jne    80103dc0 <exit+0x90>
80103dd0:	3b 50 20             	cmp    0x20(%eax),%edx
80103dd3:	75 eb                	jne    80103dc0 <exit+0x90>
      p->state = RUNNABLE;
...
80103ddf:	3d 14 38 11 80       	cmp    $0x80113814,%eax
80103de4:	75 e4                	jne    80103dca <exit+0x9a>
  wakeup1(proc->parent);
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->parent == proc){
      p->parent = initproc;
80103de6:	8b 1d bc a5 10 80    	mov    0x8010a5bc,%ebx
80103dec:	ba 14 19 11 80       	mov    $0x80111914,%edx
80103df1:	eb 10                	jmp    80103e03 <exit+0xd3>
80103df3:	90                   	nop
80103df4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103df8:	83 c2 7c             	add    $0x7c,%edx
80103dfb:	81 fa 14 38 11 80    	cmp    $0x80113814,%edx
80103e01:	74 33                	je     80103e36 <exit+0x106>
    if(p->parent == proc){
80103e03:	3b 4a 14             	cmp    0x14(%edx),%ecx
80103e06:	75 f0                	jne    80103df8 <exit+0xc8>
      p->parent = initproc;
      if(p->state == ZOMBIE)
80103e08:	83 7a 0c 05          	cmpl   $0x5,0xc(%edx)
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->parent == proc){
      p->parent = initproc;
80103e0c:	89 5a 14             	mov    %ebx,0x14(%edx)
      if(p->state == ZOMBIE)
80103e0f:	75 e7                	jne    80103df8 <exit+0xc8>
80103e11:	b8 14 19 11 80       	mov    $0x80111914,%eax
80103e16:	eb 0a                	jmp    80103e22 <exit+0xf2>
static void
wakeup1(void *chan)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e18:	83 c0 7c             	add    $0x7c,%eax
80103e1b:	3d 14 38 11 80       	cmp    $0x80113814,%eax
80103e20:	74 d6                	je     80103df8 <exit+0xc8>
    if(p->state == SLEEPING && p->chan == chan)
80103e22:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103e26:	75 f0                	jne    80103e18 <exit+0xe8>
80103e28:	3b 58 20             	cmp    0x20(%eax),%ebx
80103e2b:	75 eb                	jne    80103e18 <exit+0xe8>
      p->state = RUNNABLE;
80103e2d:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
80103e34:	eb e2                	jmp    80103e18 <exit+0xe8>
        wakeup1(initproc);
    }
  }
  ...
  proc->state = ZOMBIE;
80103e36:	c7 41 0c 05 00 00 00 	movl   $0x5,0xc(%ecx)
  sched();
80103e3d:	e8 4e fe ff ff       	call   80103c90 <sched>
  panic("zombie exit");
80103e42:	c7 04 24 35 75 10 80 	movl   $0x80107535,(%esp)
80103e49:	e8 e2 c4 ff ff       	call   80100330 <panic>
{
  struct proc *p;
  int fd;
  ...
  if(proc == initproc)
    panic("init exiting");
80103e4e:	c7 04 24 28 75 10 80 	movl   $0x80107528,(%esp)
80103e55:	e8 d6 c4 ff ff       	call   80100330 <panic>
...
80103e66:	c7 04 24 e0 18 11 80 	movl   $0x801118e0,(%esp)
80103e6d:	e8 fe 03 00 00       	call   80104270 <acquire>
  proc->state = RUNNABLE;
80103e72:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80103e78:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80103e7f:	e8 0c fe ff ff       	call   80103c90 <sched>
  release(&ptable.lock);
80103e84:	c7 04 24 e0 18 11 80 	movl   $0x801118e0,(%esp)
80103e8b:	e8 10 05 00 00       	call   801043a0 <release>
}
80103e90:	c9                   	leave  
80103e91:	c3                   	ret    
...
80103ec0:	81 fb e0 18 11 80    	cmp    $0x801118e0,%ebx
80103ec6:	74 50                	je     80103f18 <sleep+0x78>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103ec8:	c7 04 24 e0 18 11 80 	movl   $0x801118e0,(%esp)
80103ecf:	e8 9c 03 00 00       	call   80104270 <acquire>
    release(lk);
80103ed4:	89 1c 24             	mov    %ebx,(%esp)
80103ed7:	e8 c4 04 00 00       	call   801043a0 <release>
  }
...
80103ee5:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
80103eec:	e8 9f fd ff ff       	call   80103c90 <sched>
...
80103ef7:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
80103efe:	c7 04 24 e0 18 11 80 	movl   $0x801118e0,(%esp)
80103f05:	e8 96 04 00 00       	call   801043a0 <release>
    acquire(lk);
...
80103f12:	5d                   	pop    %ebp
  ...
  if(lk != &ptable.lock){  //DOC: sleeplock2
    release(&ptable.lock);
    acquire(lk);
80103f13:	e9 58 03 00 00       	jmp    80104270 <acquire>
    acquire(&ptable.lock);  //DOC: sleeplock1
    release(lk);
  }
...
80103f1b:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
80103f22:	e8 69 fd ff ff       	call   80103c90 <sched>
...
80103f3b:	c7 04 24 47 75 10 80 	movl   $0x80107547,(%esp)
80103f42:	e8 e9 c3 ff ff       	call   80100330 <panic>
// Reacquires lock when awakened.
void
sleep(void *chan, struct spinlock *lk)
{
  if(proc == 0)
    panic("sleep");
80103f47:	c7 04 24 41 75 10 80 	movl   $0x80107541,(%esp)
80103f4e:	e8 dd c3 ff ff       	call   80100330 <panic>
...
80103f65:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&ptable.lock);
80103f68:	c7 04 24 e0 18 11 80 	movl   $0x801118e0,(%esp)
80103f6f:	e8 fc 02 00 00       	call   80104270 <acquire>
...
80103f7a:	31 d2                	xor    %edx,%edx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f7c:	bb 14 19 11 80       	mov    $0x80111914,%ebx
80103f81:	eb 10                	jmp    80103f93 <wait+0x33>
80103f83:	90                   	nop
80103f84:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103f88:	83 c3 7c             	add    $0x7c,%ebx
80103f8b:	81 fb 14 38 11 80    	cmp    $0x80113814,%ebx
80103f91:	74 1d                	je     80103fb0 <wait+0x50>
      if(p->parent != proc)
80103f93:	39 43 14             	cmp    %eax,0x14(%ebx)
80103f96:	75 f0                	jne    80103f88 <wait+0x28>
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
80103f98:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103f9c:	74 2f                	je     80103fcd <wait+0x6d>
...
80103fa1:	ba 01 00 00 00       	mov    $0x1,%edx
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fa6:	81 fb 14 38 11 80    	cmp    $0x80113814,%ebx
80103fac:	75 e5                	jne    80103f93 <wait+0x33>
...
80103fb2:	74 6e                	je     80104022 <wait+0xc2>
80103fb4:	8b 50 24             	mov    0x24(%eax),%edx
80103fb7:	85 d2                	test   %edx,%edx
80103fb9:	75 67                	jne    80104022 <wait+0xc2>
      release(&ptable.lock);
      return -1;
    }
...
80103fbb:	c7 44 24 04 e0 18 11 	movl   $0x801118e0,0x4(%esp)
80103fc2:	80 
80103fc3:	89 04 24             	mov    %eax,(%esp)
80103fc6:	e8 d5 fe ff ff       	call   80103ea0 <sleep>
  }
80103fcb:	eb a7                	jmp    80103f74 <wait+0x14>
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
        // Found one.
        pid = p->pid;
        kfree(p->kstack);
80103fcd:	8b 43 08             	mov    0x8(%ebx),%eax
      if(p->parent != proc)
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
...
80103fd6:	e8 05 e3 ff ff       	call   801022e0 <kfree>
        p->kstack = 0;
        freevm(p->pgdir);
...
80103fe8:	e8 13 2c 00 00       	call   80106c00 <freevm>
        p->pid = 0;
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
        p->state = UNUSED;
        release(&ptable.lock);
80103fed:	c7 04 24 e0 18 11 80 	movl   $0x801118e0,(%esp)
        // Found one.
        pid = p->pid;
        kfree(p->kstack);
        p->kstack = 0;
        freevm(p->pgdir);
        p->pid = 0;
80103ff4:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103ffb:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80104002:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80104006:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
8010400d:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80104014:	e8 87 03 00 00       	call   801043a0 <release>
    }
...
80104021:	c3                   	ret    
    ...
    if(!havekids || proc->killed){
      release(&ptable.lock);
80104022:	c7 04 24 e0 18 11 80 	movl   $0x801118e0,(%esp)
80104029:	e8 72 03 00 00       	call   801043a0 <release>
    }
...
80104047:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
8010404a:	c7 04 24 e0 18 11 80 	movl   $0x801118e0,(%esp)
80104051:	e8 1a 02 00 00       	call   80104270 <acquire>
static void
wakeup1(void *chan)
{
  struct proc *p;
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104056:	b8 14 19 11 80       	mov    $0x80111914,%eax
8010405b:	eb 0d                	jmp    8010406a <wakeup+0x2a>
8010405d:	8d 76 00             	lea    0x0(%esi),%esi
80104060:	83 c0 7c             	add    $0x7c,%eax
80104063:	3d 14 38 11 80       	cmp    $0x80113814,%eax
80104068:	74 1e                	je     80104088 <wakeup+0x48>
    if(p->state == SLEEPING && p->chan == chan)
...
8010407f:	3d 14 38 11 80       	cmp    $0x80113814,%eax
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80104088:	c7 45 08 e0 18 11 80 	movl   $0x801118e0,0x8(%ebp)
}
8010408f:	83 c4 14             	add    $0x14,%esp
80104092:	5b                   	pop    %ebx
80104093:	5d                   	pop    %ebp
void
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80104094:	e9 07 03 00 00       	jmp    801043a0 <release>
...
801040a7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
801040aa:	c7 04 24 e0 18 11 80 	movl   $0x801118e0,(%esp)
801040b1:	e8 ba 01 00 00       	call   80104270 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040b6:	b8 14 19 11 80       	mov    $0x80111914,%eax
801040bb:	eb 0d                	jmp    801040ca <kill+0x2a>
801040bd:	8d 76 00             	lea    0x0(%esi),%esi
801040c0:	83 c0 7c             	add    $0x7c,%eax
801040c3:	3d 14 38 11 80       	cmp    $0x80113814,%eax
...
801040d3:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
801040da:	74 14                	je     801040f0 <kill+0x50>
        p->state = RUNNABLE;
      release(&ptable.lock);
801040dc:	c7 04 24 e0 18 11 80 	movl   $0x801118e0,(%esp)
801040e3:	e8 b8 02 00 00       	call   801043a0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801040e8:	83 c4 14             	add    $0x14,%esp
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
        p->state = RUNNABLE;
...
801040ef:	c3                   	ret    
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->pid == pid){
      ...
      if(p->state == SLEEPING)
        p->state = RUNNABLE;
801040f0:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
801040f7:	eb e3                	jmp    801040dc <kill+0x3c>
801040f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  release(&ptable.lock);
80104100:	c7 04 24 e0 18 11 80 	movl   $0x801118e0,(%esp)
80104107:	e8 94 02 00 00       	call   801043a0 <release>
  return -1;
}
8010410c:	83 c4 14             	add    $0x14,%esp
      release(&ptable.lock);
      return 0;
    }
  }
...
80104126:	bb 80 19 11 80       	mov    $0x80111980,%ebx
8010412b:	83 ec 4c             	sub    $0x4c,%esp
8010412e:	8d 75 e8             	lea    -0x18(%ebp),%esi
80104131:	eb 20                	jmp    80104153 <procdump+0x33>
80104133:	90                   	nop
80104134:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80104138:	c7 04 24 c6 73 10 80 	movl   $0x801073c6,(%esp)
8010413f:	e8 dc c4 ff ff       	call   80100620 <cprintf>
80104144:	83 c3 7c             	add    $0x7c,%ebx
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104147:	81 fb 80 38 11 80    	cmp    $0x80113880,%ebx
8010414d:	0f 84 8d 00 00 00    	je     801041e0 <procdump+0xc0>
    if(p->state == UNUSED)
80104153:	8b 43 a0             	mov    -0x60(%ebx),%eax
80104156:	85 c0                	test   %eax,%eax
80104158:	74 ea                	je     80104144 <procdump+0x24>
      continue;
...
8010415a:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
8010415d:	ba 58 75 10 80       	mov    $0x80107558,%edx
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->state == UNUSED)
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104162:	77 11                	ja     80104175 <procdump+0x55>
80104164:	8b 14 85 90 75 10 80 	mov    -0x7fef8a70(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
8010416b:	b8 58 75 10 80       	mov    $0x80107558,%eax
80104170:	85 d2                	test   %edx,%edx
80104172:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
80104175:	8b 43 a4             	mov    -0x5c(%ebx),%eax
80104178:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
8010417c:	89 54 24 08          	mov    %edx,0x8(%esp)
80104180:	c7 04 24 5c 75 10 80 	movl   $0x8010755c,(%esp)
80104187:	89 44 24 04          	mov    %eax,0x4(%esp)
8010418b:	e8 90 c4 ff ff       	call   80100620 <cprintf>
    if(p->state == SLEEPING){
80104190:	83 7b a0 02          	cmpl   $0x2,-0x60(%ebx)
80104194:	75 a2                	jne    80104138 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104196:	8d 45 c0             	lea    -0x40(%ebp),%eax
80104199:	89 44 24 04          	mov    %eax,0x4(%esp)
8010419d:	8b 43 b0             	mov    -0x50(%ebx),%eax
801041a0:	8d 7d c0             	lea    -0x40(%ebp),%edi
801041a3:	8b 40 0c             	mov    0xc(%eax),%eax
801041a6:	83 c0 08             	add    $0x8,%eax
801041a9:	89 04 24             	mov    %eax,(%esp)
801041ac:	e8 5f 00 00 00       	call   80104210 <getcallerpcs>
...
801041c9:	c7 04 24 c2 6e 10 80 	movl   $0x80106ec2,(%esp)
801041d0:	e8 4b c4 ff ff       	call   80100620 <cprintf>
    else
      state = "???";
    cprintf("%d %s %s", p->pid, state, p->name);
    if(p->state == SLEEPING){
...
80104278:	fa                   	cli    
{
  ...
  cli();
  if(cpu->ncli == 0)
80104279:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010427f:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80104285:	85 d2                	test   %edx,%edx
80104287:	75 0c                	jne    80104295 <acquire+0x25>
    cpu->intena = eflags & FL_IF;
80104289:	81 e1 00 02 00 00    	and    $0x200,%ecx
8010428f:	89 88 b0 00 00 00    	mov    %ecx,0xb0(%eax)
  cpu->ncli += 1;
80104295:	83 c2 01             	add    $0x1,%edx
80104298:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
// other CPUs to waste time spinning to acquire it.
void
acquire(struct spinlock *lk)
{
...
801042a1:	8b 0a                	mov    (%edx),%ecx
801042a3:	85 c9                	test   %ecx,%ecx
801042a5:	74 05                	je     801042ac <acquire+0x3c>
801042a7:	3b 42 08             	cmp    0x8(%edx),%eax
801042aa:	74 3c                	je     801042e8 <acquire+0x78>
xchg(volatile uint *addr, uint newval)
{
  uint result;
  ...
  // The + in "+m" denotes a read-modify-write operand.
  asm volatile("lock; xchgl %0, %1" :
801042ac:	b9 01 00 00 00       	mov    $0x1,%ecx
801042b1:	eb 08                	jmp    801042bb <acquire+0x4b>
801042b3:	90                   	nop
801042b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801042b8:	8b 55 08             	mov    0x8(%ebp),%edx
801042bb:	89 c8                	mov    %ecx,%eax
...
801042c2:	75 f4                	jne    801042b8 <acquire+0x48>
    ;
...
801042ca:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
  getcallerpcs(&lk, lk->pcs);
801042d1:	83 c0 0c             	add    $0xc,%eax
  // past this point, to ensure that the critical section's memory
  // references happen after the lock is acquired.
  __sync_synchronize();
  ...
  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
801042d4:	89 50 fc             	mov    %edx,-0x4(%eax)
  getcallerpcs(&lk, lk->pcs);
801042d7:	89 44 24 04          	mov    %eax,0x4(%esp)
801042db:	8d 45 08             	lea    0x8(%ebp),%eax
801042de:	89 04 24             	mov    %eax,(%esp)
801042e1:	e8 2a ff ff ff       	call   80104210 <getcallerpcs>
}
801042e6:	c9                   	leave  
801042e7:	c3                   	ret    
void
acquire(struct spinlock *lk)
{
  ...
  if(holding(lk))
    panic("acquire");
801042e8:	c7 04 24 a8 75 10 80 	movl   $0x801075a8,(%esp)
801042ef:	e8 3c c0 ff ff       	call   80100330 <panic>
...
80104305:	8b 55 08             	mov    0x8(%ebp),%edx
  return lock->locked && lock->cpu == cpu;
80104308:	8b 0a                	mov    (%edx),%ecx
8010430a:	85 c9                	test   %ecx,%ecx
8010430c:	74 0f                	je     8010431d <holding+0x1d>
8010430e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104314:	39 42 08             	cmp    %eax,0x8(%edx)
80104317:	0f 94 c0             	sete   %al
8010431a:	0f b6 c0             	movzbl %al,%eax
}
8010431d:	5d                   	pop    %ebp
8010431e:	c3                   	ret    
8010431f:	90                   	nop
...
8010432c:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80104332:	85 d2                	test   %edx,%edx
80104334:	75 0c                	jne    80104342 <pushcli+0x22>
    cpu->intena = eflags & FL_IF;
80104336:	81 e1 00 02 00 00    	and    $0x200,%ecx
8010433c:	89 88 b0 00 00 00    	mov    %ecx,0xb0(%eax)
  cpu->ncli += 1;
80104342:	83 c2 01             	add    $0x1,%edx
80104345:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
}
8010434b:	5d                   	pop    %ebp
8010434c:	c3                   	ret    
...
8010435b:	75 34                	jne    80104391 <popcli+0x41>
    panic("popcli - interruptible");
  if(--cpu->ncli < 0)
8010435d:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104363:	8b 88 ac 00 00 00    	mov    0xac(%eax),%ecx
80104369:	8d 51 ff             	lea    -0x1(%ecx),%edx
8010436c:	85 d2                	test   %edx,%edx
8010436e:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80104374:	78 0f                	js     80104385 <popcli+0x35>
    panic("popcli");
  if(cpu->ncli == 0 && cpu->intena)
80104376:	75 0b                	jne    80104383 <popcli+0x33>
80104378:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
8010437e:	85 c0                	test   %eax,%eax
80104380:	74 01                	je     80104383 <popcli+0x33>
}
...
popcli(void)
{
  ...
  if(--cpu->ncli < 0)
    panic("popcli");
80104385:	c7 04 24 c7 75 10 80 	movl   $0x801075c7,(%esp)
8010438c:	e8 9f bf ff ff       	call   80100330 <panic>
...
popcli(void)
{
  if(readeflags()&FL_IF)
    panic("popcli - interruptible");
80104391:	c7 04 24 b0 75 10 80 	movl   $0x801075b0,(%esp)
80104398:	e8 93 bf ff ff       	call   80100330 <panic>
...
801043af:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
801043b6:	39 50 08             	cmp    %edx,0x8(%eax)
...
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
801043bb:	c7 04 24 ce 75 10 80 	movl   $0x801075ce,(%esp)
801043c2:	e8 69 bf ff ff       	call   80100330 <panic>
801043c7:	90                   	nop
...
801043df:	c9                   	leave  
  ...
  popcli();
801043e0:	e9 6b ff ff ff       	jmp    80104350 <popcli>
...
swtch:
  movl 4(%esp), %eax
8010462c:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80104630:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80104637:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80104638:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
8010463a:	89 d4                	mov    %edx,%esp
...
8010463f:	5d                   	pop    %ebp
  ret
80104640:	c3                   	ret    
80104641:	66 90                	xchg   %ax,%ax
80104643:	66 90                	xchg   %ax,%ax
...
801046a9:	eb 1d                	jmp    801046c8 <fetchstr+0x48>
801046ab:	90                   	nop
...
801046dd:	8b 42 18             	mov    0x18(%edx),%eax
...
801046e5:	8d 04 88             	lea    (%eax,%ecx,4),%eax
801046e8:	8d 48 04             	lea    0x4(%eax),%ecx
...
{
  if(addr >= proc->sz || addr+4 > proc->sz)
801046eb:	39 d1                	cmp    %edx,%ecx
801046ed:	73 19                	jae    80104708 <argint+0x38>
801046ef:	8d 48 08             	lea    0x8(%eax),%ecx
801046f2:	39 ca                	cmp    %ecx,%edx
801046f4:	72 12                	jb     80104708 <argint+0x38>
    return -1;
  *ip = *(int*)(addr);
801046f6:	8b 50 04             	mov    0x4(%eax),%edx
801046f9:	8b 45 0c             	mov    0xc(%ebp),%eax
...
{
  return fetchint(proc->tf->esp + 4 + 4*n, ip);
8010471a:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010471d:	8b 50 18             	mov    0x18(%eax),%edx
80104720:	8b 52 44             	mov    0x44(%edx),%edx
80104723:	8d 0c 8a             	lea    (%edx,%ecx,4),%ecx
...
{
  return fetchint(proc->tf->esp + 4 + 4*n, ip);
8010472d:	8d 59 04             	lea    0x4(%ecx),%ebx
...
{
  if(addr >= proc->sz || addr+4 > proc->sz)
80104730:	39 d3                	cmp    %edx,%ebx
80104732:	73 1e                	jae    80104752 <argptr+0x42>
80104734:	8d 59 08             	lea    0x8(%ecx),%ebx
80104737:	39 da                	cmp    %ebx,%edx
80104739:	72 17                	jb     80104752 <argptr+0x42>
    return -1;
  *ip = *(int*)(addr);
8010473b:	8b 49 04             	mov    0x4(%ecx),%ecx
{
  int i;
...
8010473e:	39 d1                	cmp    %edx,%ecx
80104740:	73 10                	jae    80104752 <argptr+0x42>
80104742:	8b 5d 10             	mov    0x10(%ebp),%ebx
80104745:	01 cb                	add    %ecx,%ebx
80104747:	39 d3                	cmp    %edx,%ebx
80104749:	77 07                	ja     80104752 <argptr+0x42>
    return -1;
  *pp = (char*)i;
8010474b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010474e:	89 08                	mov    %ecx,(%eax)
  return 0;
...
8010476c:	8b 50 18             	mov    0x18(%eax),%edx
...
{
  return fetchint(proc->tf->esp + 4 + 4*n, ip);
80104771:	8b 52 44             	mov    0x44(%edx),%edx
80104774:	8d 14 8a             	lea    (%edx,%ecx,4),%edx
80104777:	8d 4a 04             	lea    0x4(%edx),%ecx
...
{
  if(addr >= proc->sz || addr+4 > proc->sz)
8010477a:	39 c1                	cmp    %eax,%ecx
8010477c:	73 07                	jae    80104785 <argstr+0x25>
8010477e:	8d 4a 08             	lea    0x8(%edx),%ecx
80104781:	39 c8                	cmp    %ecx,%eax
80104783:	73 0b                	jae    80104790 <argstr+0x30>
int
argstr(int n, char **pp)
{
  int addr;
...
fetchint(uint addr, int *ip)
{
  if(addr >= proc->sz || addr+4 > proc->sz)
    return -1;
  *ip = *(int*)(addr);
80104790:	8b 4a 04             	mov    0x4(%edx),%ecx
int
fetchstr(uint addr, char **pp)
{
  char *s, *ep;
  ...
  if(addr >= proc->sz)
80104793:	39 c1                	cmp    %eax,%ecx
80104795:	73 ee                	jae    80104785 <argstr+0x25>
    return -1;
  *pp = (char*)addr;
80104797:	8b 55 0c             	mov    0xc(%ebp),%edx
8010479a:	89 c8                	mov    %ecx,%eax
8010479c:	89 0a                	mov    %ecx,(%edx)
  ep = (char*)proc->sz;
8010479e:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801047a5:	8b 12                	mov    (%edx),%edx
  for(s = *pp; s < ep; s++)
801047a7:	39 d1                	cmp    %edx,%ecx
801047a9:	73 da                	jae    80104785 <argstr+0x25>
    if(*s == 0)
801047ab:	80 39 00             	cmpb   $0x0,(%ecx)
801047ae:	75 12                	jne    801047c2 <argstr+0x62>
801047b0:	eb 1e                	jmp    801047d0 <argstr+0x70>
801047b2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801047b8:	80 38 00             	cmpb   $0x0,(%eax)
801047bb:	90                   	nop
801047bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801047c0:	74 0e                	je     801047d0 <argstr+0x70>
...
801047c7:	77 ef                	ja     801047b8 <argstr+0x58>
801047c9:	eb ba                	jmp    80104785 <argstr+0x25>
801047cb:	90                   	nop
801047cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(*s == 0)
      return s - *pp;
801047d0:	29 c8                	sub    %ecx,%eax
{
  int addr;
  if(argint(n, &addr) < 0)
    return -1;
...
801047e4:	83 ec 14             	sub    $0x14,%esp
  int num;

  num = proc->tf->eax;
801047e7:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
801047ee:	8b 5a 18             	mov    0x18(%edx),%ebx
801047f1:	8b 43 1c             	mov    0x1c(%ebx),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
801047f4:	8d 48 ff             	lea    -0x1(%eax),%ecx
801047f7:	83 f9 1a             	cmp    $0x1a,%ecx
801047fa:	77 1c                	ja     80104818 <syscall+0x38>
801047fc:	8b 0c 85 00 76 10 80 	mov    -0x7fef8a00(,%eax,4),%ecx
80104803:	85 c9                	test   %ecx,%ecx
80104805:	74 11                	je     80104818 <syscall+0x38>
    proc->tf->eax = syscalls[num]();
80104807:	ff d1                	call   *%ecx
80104809:	89 43 1c             	mov    %eax,0x1c(%ebx)
  } else {
...
8010480c:	83 c4 14             	add    $0x14,%esp
8010480f:	5b                   	pop    %ebx
80104810:	5d                   	pop    %ebp
80104811:	c3                   	ret    
...
80104818:	89 44 24 0c          	mov    %eax,0xc(%esp)
            proc->pid, proc->name, num);
8010481c:	8d 42 6c             	lea    0x6c(%edx),%eax
8010481f:	89 44 24 08          	mov    %eax,0x8(%esp)
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
80104823:	8b 42 10             	mov    0x10(%edx),%eax
80104826:	c7 04 24 d6 75 10 80 	movl   $0x801075d6,(%esp)
8010482d:	89 44 24 04          	mov    %eax,0x4(%esp)
80104831:	e8 ea bd ff ff       	call   80100620 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
80104836:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010483c:	8b 40 18             	mov    0x18(%eax),%eax
8010483f:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
80104846:	83 c4 14             	add    $0x14,%esp
80104849:	5b                   	pop    %ebx
8010484a:	5d                   	pop    %ebp
8010484b:	c3                   	ret    
...
8010486c:	89 4d bc             	mov    %ecx,-0x44(%ebp)
  ...
  if((dp = nameiparent(path, name)) == 0)
8010486f:	e8 8c d6 ff ff       	call   80101f00 <nameiparent>
...
80104881:	e8 ba cd ff ff       	call   80101640 <ilock>
...
801048cb:	e8 20 d0 ff ff       	call   801018f0 <iunlockput>
    panic("create: dirlink");
...
801048ed:	e8 be cb ff ff       	call   801014b0 <ialloc>
...
801048ff:	e8 3c cd ff ff       	call   80101640 <ilock>
  ip->major = major;
80104904:	0f b7 45 c0          	movzwl -0x40(%ebp),%eax
80104908:	66 89 46 12          	mov    %ax,0x12(%esi)
  ip->minor = minor;
8010490c:	0f b7 45 bc          	movzwl -0x44(%ebp),%eax
80104910:	66 89 46 14          	mov    %ax,0x14(%esi)
  ip->nlink = 1;
80104914:	b8 01 00 00 00       	mov    $0x1,%eax
80104919:	66 89 46 16          	mov    %ax,0x16(%esi)
  iupdate(ip);
8010491d:	89 34 24             	mov    %esi,(%esp)
80104920:	e8 5b cc ff ff       	call   80101580 <iupdate>
...
8010493a:	e8 c1 d4 ff ff       	call   80101e00 <dirlink>
...
80104946:	e8 a5 cf ff ff       	call   801018f0 <iunlockput>
...
8010495f:	90                   	nop
  ...
  if(type == T_DIR){  // Create . and .. entries.
    dp->nlink++;  // for ".."
80104960:	66 83 47 16 01       	addw   $0x1,0x16(%edi)
    iupdate(dp);
80104965:	89 3c 24             	mov    %edi,(%esp)
80104968:	e8 13 cc ff ff       	call   80101580 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
8010496d:	8b 46 04             	mov    0x4(%esi),%eax
80104970:	c7 44 24 04 8c 76 10 	movl   $0x8010768c,0x4(%esp)
80104977:	80 
80104978:	89 34 24             	mov    %esi,(%esp)
8010497b:	89 44 24 08          	mov    %eax,0x8(%esp)
8010497f:	e8 7c d4 ff ff       	call   80101e00 <dirlink>
80104984:	85 c0                	test   %eax,%eax
80104986:	78 1b                	js     801049a3 <create+0x153>
80104988:	8b 47 04             	mov    0x4(%edi),%eax
8010498b:	c7 44 24 04 8b 76 10 	movl   $0x8010768b,0x4(%esp)
80104992:	80 
80104993:	89 34 24             	mov    %esi,(%esp)
80104996:	89 44 24 08          	mov    %eax,0x8(%esp)
8010499a:	e8 61 d4 ff ff       	call   80101e00 <dirlink>
8010499f:	85 c0                	test   %eax,%eax
801049a1:	79 89                	jns    8010492c <create+0xdc>
      panic("create dots");
801049a3:	c7 04 24 7f 76 10 80 	movl   $0x8010767f,(%esp)
801049aa:	e8 81 b9 ff ff       	call   80100330 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
801049af:	c7 04 24 8e 76 10 80 	movl   $0x8010768e,(%esp)
801049b6:	e8 75 b9 ff ff       	call   80100330 <panic>
    iunlockput(ip);
    return 0;
  }
  ...
  if((ip = ialloc(dp->dev, type)) == 0)
    panic("create: ialloc");
801049bb:	c7 04 24 70 76 10 80 	movl   $0x80107670,(%esp)
801049c2:	e8 69 b9 ff ff       	call   80100330 <panic>
...
801049f1:	78 35                	js     80104a28 <argfd.constprop.0+0x58>
    return -1;
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
801049f3:	8b 4d f4             	mov    -0xc(%ebp),%ecx
801049f6:	83 f9 0f             	cmp    $0xf,%ecx
801049f9:	77 2d                	ja     80104a28 <argfd.constprop.0+0x58>
801049fb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a01:	8b 44 88 28          	mov    0x28(%eax,%ecx,4),%eax
80104a05:	85 c0                	test   %eax,%eax
80104a07:	74 1f                	je     80104a28 <argfd.constprop.0+0x58>
    return -1;
  if(pfd)
80104a09:	85 f6                	test   %esi,%esi
80104a0b:	74 02                	je     80104a0f <argfd.constprop.0+0x3f>
    *pfd = fd;
80104a0d:	89 0e                	mov    %ecx,(%esi)
  if(pf)
80104a0f:	85 db                	test   %ebx,%ebx
80104a11:	74 0d                	je     80104a20 <argfd.constprop.0+0x50>
    *pf = f;
...
80104a22:	eb f3                	jmp    80104a17 <argfd.constprop.0+0x47>
...
80104a2d:	eb e8                	jmp    80104a17 <argfd.constprop.0+0x47>
80104a2f:	90                   	nop
...
80104a3c:	e8 8f ff ff ff       	call   801049d0 <argfd.constprop.0>
80104a41:	85 c0                	test   %eax,%eax
80104a43:	78 1b                	js     80104a60 <sys_dup+0x30>
    return -1;
  if((fd=fdalloc(f)) < 0)
...
80104a56:	74 18                	je     80104a70 <sys_dup+0x40>
static int
fdalloc(struct file *f)
{
  int fd;
...
80104a5b:	83 fb 10             	cmp    $0x10,%ebx
80104a5e:	75 f0                	jne    80104a50 <sys_dup+0x20>
    return -1;
  if((fd=fdalloc(f)) < 0)
    return -1;
  filedup(f);
...
80104a6c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
80104a70:	89 54 98 28          	mov    %edx,0x28(%eax,%ebx,4)
  ...
  if((fd=fdalloc(f)) < 0)
    return -1;
  filedup(f);
80104a74:	89 14 24             	mov    %edx,(%esp)
80104a77:	e8 24 c3 ff ff       	call   80100da0 <filedup>
  return fd;
}
80104a7c:	83 c4 24             	add    $0x24,%esp
  if(argfd(0, 0, &f) < 0)
    return -1;
  if((fd=fdalloc(f)) < 0)
    return -1;
...
80104a9b:	e8 30 ff ff ff       	call   801049d0 <argfd.constprop.0>
...
80104ab2:	e8 19 fc ff ff       	call   801046d0 <argint>
...
80104aed:	e8 0e c4 ff ff       	call   80100f00 <fileread>
}
80104af2:	c9                   	leave  
80104af3:	c3                   	ret    
...
80104b0b:	e8 c0 fe ff ff       	call   801049d0 <argfd.constprop.0>
...
80104b22:	e8 a9 fb ff ff       	call   801046d0 <argint>
...
80104b5d:	e8 3e c4 ff ff       	call   80100fa0 <filewrite>
}
80104b62:	c9                   	leave  
80104b63:	c3                   	ret    
...
80104b7c:	e8 4f fe ff ff       	call   801049d0 <argfd.constprop.0>
...
80104b8e:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
80104b95:	00 
  fileclose(f);
80104b96:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b99:	89 04 24             	mov    %eax,(%esp)
80104b9c:	e8 4f c2 ff ff       	call   80100df0 <fileclose>
  return 0;
...
80104bbb:	e8 10 fe ff ff       	call   801049d0 <argfd.constprop.0>
...
80104bf0:	e8 bb c2 ff ff       	call   80100eb0 <filestat>
}
80104bf5:	c9                   	leave  
80104bf6:	c3                   	ret    
80104bf7:	90                   	nop
...
80104c17:	e8 44 fb ff ff       	call   80104760 <argstr>
...
80104c5c:	e8 df c9 ff ff       	call   80101640 <ilock>
  if(ip->type == T_DIR){
...
80104c77:	e8 04 c9 ff ff       	call   80101580 <iupdate>
  iunlock(ip);
80104c7c:	89 1c 24             	mov    %ebx,(%esp)
80104c7f:	e8 cc ca ff ff       	call   80101750 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80104c84:	8b 45 d0             	mov    -0x30(%ebp),%eax
80104c87:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104c8b:	89 04 24             	mov    %eax,(%esp)
80104c8e:	e8 6d d2 ff ff       	call   80101f00 <nameiparent>
...
80104c9c:	e8 9f c9 ff ff       	call   80101640 <ilock>
...
80104cb5:	e8 46 d1 ff ff       	call   80101e00 <dirlink>
...
80104cc1:	e8 2a cc ff ff       	call   801018f0 <iunlockput>
  iput(ip);
80104cc6:	89 1c 24             	mov    %ebx,(%esp)
80104cc9:	e8 d2 ca ff ff       	call   801017a0 <iput>

  end_op();
80104cce:	e8 1d df ff ff       	call   80102bf0 <end_op>
  ip->nlink--;
  iupdate(ip);
  iunlockput(ip);
  end_op();
...
80104ce3:	e8 08 cc ff ff       	call   801018f0 <iunlockput>
  end_op();
...
80104ceb:	e8 50 c9 ff ff       	call   80101640 <ilock>
  ip->nlink--;
80104cf0:	66 83 6b 16 01       	subw   $0x1,0x16(%ebx)
  iupdate(ip);
80104cf5:	89 1c 24             	mov    %ebx,(%esp)
80104cf8:	e8 83 c8 ff ff       	call   80101580 <iupdate>
  iunlockput(ip);
80104cfd:	89 1c 24             	mov    %ebx,(%esp)
80104d00:	e8 eb cb ff ff       	call   801018f0 <iunlockput>
  end_op();
80104d05:	e8 e6 de ff ff       	call   80102bf0 <end_op>
  return -1;
}
...
80104d37:	e8 24 fa ff ff       	call   80104760 <argstr>
80104d3c:	85 c0                	test   %eax,%eax
80104d3e:	0f 88 76 01 00 00    	js     80104eba <sys_unlink+0x19a>
    return -1;

  begin_op();
80104d44:	e8 37 de ff ff       	call   80102b80 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80104d56:	e8 a5 d1 ff ff       	call   80101f00 <nameiparent>
...
80104d6c:	e8 cf c8 ff ff       	call   80101640 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104d71:	c7 44 24 04 8c 76 10 	movl   $0x8010768c,0x4(%esp)
80104d78:	80 
80104d79:	89 1c 24             	mov    %ebx,(%esp)
80104d7c:	e8 ef cd ff ff       	call   80101b70 <namecmp>
80104d81:	85 c0                	test   %eax,%eax
80104d83:	0f 84 21 01 00 00    	je     80104eaa <sys_unlink+0x18a>
80104d89:	c7 44 24 04 8b 76 10 	movl   $0x8010768b,0x4(%esp)
80104d90:	80 
80104d91:	89 1c 24             	mov    %ebx,(%esp)
80104d94:	e8 d7 cd ff ff       	call   80101b70 <namecmp>
...
80104daf:	e8 ec cd ff ff       	call   80101ba0 <dirlookup>
...
80104dc1:	e8 7a c8 ff ff       	call   80101640 <ilock>

  if(ip->nlink < 1)
80104dc6:	66 83 7b 16 00       	cmpw   $0x0,0x16(%ebx)
80104dcb:	0f 8e 24 01 00 00    	jle    80104ef5 <sys_unlink+0x1d5>
    panic("unlink: nlink < 1");
  if(ip->type == T_DIR && !isdirempty(ip)){
80104dd1:	66 83 7b 10 01       	cmpw   $0x1,0x10(%ebx)
...
80104e2b:	e8 c0 ca ff ff       	call   801018f0 <iunlockput>

  ip->nlink--;
80104e30:	66 83 6b 16 01       	subw   $0x1,0x16(%ebx)
  iupdate(ip);
80104e35:	89 1c 24             	mov    %ebx,(%esp)
80104e38:	e8 43 c7 ff ff       	call   80101580 <iupdate>
  iunlockput(ip);
...
80104e58:	83 7b 18 20          	cmpl   $0x20,0x18(%ebx)
...
80104e73:	3b 53 18             	cmp    0x18(%ebx),%edx
...
80104e91:	e8 aa ca ff ff       	call   80101940 <readi>
...
80104ea5:	e8 46 ca ff ff       	call   801018f0 <iunlockput>
  end_op();
...
80104ecb:	66 83 68 16 01       	subw   $0x1,0x16(%eax)
    iupdate(dp);
80104ed0:	89 04 24             	mov    %eax,(%esp)
80104ed3:	e8 a8 c6 ff ff       	call   80101580 <iupdate>
80104ed8:	e9 48 ff ff ff       	jmp    80104e25 <sys_unlink+0x105>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
80104edd:	c7 04 24 b0 76 10 80 	movl   $0x801076b0,(%esp)
80104ee4:	e8 47 b4 ff ff       	call   80100330 <panic>
    goto bad;
  }
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("unlink: writei");
80104ee9:	c7 04 24 c2 76 10 80 	movl   $0x801076c2,(%esp)
80104ef0:	e8 3b b4 ff ff       	call   80100330 <panic>
  if((ip = dirlookup(dp, name, &off)) == 0)
    goto bad;
  ilock(ip);
  ...
  if(ip->nlink < 1)
    panic("unlink: nlink < 1");
80104ef5:	c7 04 24 9e 76 10 80 	movl   $0x8010769e,(%esp)
80104efc:	e8 2f b4 ff ff       	call   80100330 <panic>
...
80104f27:	e8 34 f8 ff ff       	call   80104760 <argstr>
80104f2c:	85 c0                	test   %eax,%eax
80104f2e:	0f 88 81 00 00 00    	js     80104fb5 <sys_open+0xa5>
80104f34:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80104f37:	89 44 24 04          	mov    %eax,0x4(%esp)
80104f3b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104f42:	e8 89 f7 ff ff       	call   801046d0 <argint>
80104f47:	85 c0                	test   %eax,%eax
80104f49:	78 6a                	js     80104fb5 <sys_open+0xa5>
    return -1;

  begin_op();
80104f4b:	e8 30 dc ff ff       	call   80102b80 <begin_op>

  if(omode & O_CREATE){
80104f50:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
80104f54:	75 72                	jne    80104fc8 <sys_open+0xb8>
    if(ip == 0){
      end_op();
      return -1;
    }
...
80104f5c:	e8 7f cf ff ff       	call   80101ee0 <namei>
80104f61:	85 c0                	test   %eax,%eax
80104f63:	89 c7                	mov    %eax,%edi
80104f65:	74 49                	je     80104fb0 <sys_open+0xa0>
      end_op();
      return -1;
    }
    ilock(ip);
80104f67:	89 04 24             	mov    %eax,(%esp)
80104f6a:	e8 d1 c6 ff ff       	call   80101640 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80104f6f:	66 83 7f 10 01       	cmpw   $0x1,0x10(%edi)
80104f74:	0f 84 ae 00 00 00    	je     80105028 <sys_open+0x118>
      end_op();
      return -1;
    }
  }
...
80104f7a:	e8 b1 bd ff ff       	call   80100d30 <filealloc>
80104f7f:	85 c0                	test   %eax,%eax
80104f81:	89 c6                	mov    %eax,%esi
80104f83:	74 23                	je     80104fa8 <sys_open+0x98>
80104f85:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104f8c:	31 db                	xor    %ebx,%ebx
...
80104f96:	74 50                	je     80104fe8 <sys_open+0xd8>
static int
fdalloc(struct file *f)
{
  int fd;
...
80104f9e:	75 f0                	jne    80104f90 <sys_open+0x80>
    }
  }
...
80104fa3:	e8 48 be ff ff       	call   80100df0 <fileclose>
    iunlockput(ip);
80104fa8:	89 3c 24             	mov    %edi,(%esp)
80104fab:	e8 40 c9 ff ff       	call   801018f0 <iunlockput>
    end_op();
...
80104fcb:	31 c9                	xor    %ecx,%ecx
80104fcd:	ba 02 00 00 00       	mov    $0x2,%edx
80104fd2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104fd9:	e8 72 f8 ff ff       	call   80104850 <create>
    if(ip == 0){
80104fde:	85 c0                	test   %eax,%eax
  ...
  if(omode & O_CREATE){
    ip = create(path, T_FILE, 0, 0);
80104fe0:	89 c7                	mov    %eax,%edi
    if(ip == 0){
80104fe2:	75 96                	jne    80104f7a <sys_open+0x6a>
80104fe4:	eb ca                	jmp    80104fb0 <sys_open+0xa0>
80104fe6:	66 90                	xchg   %ax,%ax
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
80104fe8:	89 74 9a 28          	mov    %esi,0x28(%edx,%ebx,4)
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
  ...
  iunlock(ip);
80104fec:	89 3c 24             	mov    %edi,(%esp)
80104fef:	e8 5c c7 ff ff       	call   80101750 <iunlock>
  end_op();
80104ff4:	e8 f7 db ff ff       	call   80102bf0 <end_op>

  f->type = FD_INODE;
80104ff9:	c7 06 02 00 00 00    	movl   $0x2,(%esi)
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
80104fff:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  ...
  f->type = FD_INODE;
  f->ip = ip;
80105002:	89 7e 10             	mov    %edi,0x10(%esi)
  f->off = 0;
80105005:	c7 46 14 00 00 00 00 	movl   $0x0,0x14(%esi)
  f->readable = !(omode & O_WRONLY);
8010500c:	89 d0                	mov    %edx,%eax
8010500e:	83 e0 01             	and    $0x1,%eax
80105011:	83 f0 01             	xor    $0x1,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105014:	83 e2 03             	and    $0x3,%edx
  end_op();
  ...
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
80105017:	88 46 08             	mov    %al,0x8(%esi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
  return fd;
8010501a:	89 d8                	mov    %ebx,%eax
  ...
  f->readable = !(omode & O_WRONLY);
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010501c:	0f 95 46 09          	setne  0x9(%esi)
  return fd;
}
80105020:	83 c4 2c             	add    $0x2c,%esp
80105023:	5b                   	pop    %ebx
80105024:	5e                   	pop    %esi
80105025:	5f                   	pop    %edi
80105026:	5d                   	pop    %ebp
...
8010502b:	85 d2                	test   %edx,%edx
8010502d:	0f 84 47 ff ff ff    	je     80104f7a <sys_open+0x6a>
80105033:	e9 70 ff ff ff       	jmp    80104fa8 <sys_open+0x98>
80105038:	90                   	nop
...
80105043:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
80105046:	e8 35 db ff ff       	call   80102b80 <begin_op>
...
801050a3:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
801050a6:	e8 d5 da ff ff       	call   80102b80 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
80105134:	83 ec 24             	sub    $0x24,%esp
  ...
  begin_op();
80105137:	e8 44 da ff ff       	call   80102b80 <begin_op>
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
8010513c:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010513f:	89 44 24 04          	mov    %eax,0x4(%esp)
80105143:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010514a:	e8 11 f6 ff ff       	call   80104760 <argstr>
8010514f:	85 c0                	test   %eax,%eax
80105151:	78 5a                	js     801051ad <sys_chdir+0x7d>
80105153:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105156:	89 04 24             	mov    %eax,(%esp)
80105159:	e8 82 cd ff ff       	call   80101ee0 <namei>
8010515e:	85 c0                	test   %eax,%eax
80105160:	89 c3                	mov    %eax,%ebx
80105162:	74 49                	je     801051ad <sys_chdir+0x7d>
    end_op();
    return -1;
  }
  ilock(ip);
80105164:	89 04 24             	mov    %eax,(%esp)
80105167:	e8 d4 c4 ff ff       	call   80101640 <ilock>
  if(ip->type != T_DIR){
8010516c:	66 83 7b 10 01       	cmpw   $0x1,0x10(%ebx)
    iunlockput(ip);
80105171:	89 1c 24             	mov    %ebx,(%esp)
  ...
  ilock(ip);
  if(ip->type != T_DIR){
80105174:	75 32                	jne    801051a8 <sys_chdir+0x78>
    iunlockput(ip);
    end_op();
    return -1;
  }
  iunlock(ip);
80105176:	e8 d5 c5 ff ff       	call   80101750 <iunlock>
  iput(proc->cwd);
8010517b:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105181:	8b 40 68             	mov    0x68(%eax),%eax
80105184:	89 04 24             	mov    %eax,(%esp)
80105187:	e8 14 c6 ff ff       	call   801017a0 <iput>
  end_op();
8010518c:	e8 5f da ff ff       	call   80102bf0 <end_op>
  proc->cwd = ip;
80105191:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105197:	89 58 68             	mov    %ebx,0x68(%eax)
  return 0;
}
8010519a:	83 c4 24             	add    $0x24,%esp
  }
  iunlock(ip);
  iput(proc->cwd);
  end_op();
...
801051a2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  if(ip->type != T_DIR){
    iunlockput(ip);
801051a8:	e8 43 c7 ff ff       	call   801018f0 <iunlockput>
    end_op();
801051ad:	e8 3e da ff ff       	call   80102bf0 <end_op>
  iunlock(ip);
  iput(proc->cwd);
  end_op();
  proc->cwd = ip;
...
801051b2:	83 c4 24             	add    $0x24,%esp
  }
  ilock(ip);
  if(ip->type != T_DIR){
    iunlockput(ip);
...
8010522b:	e8 c0 f1 ff ff       	call   801043f0 <memset>
  for(i=0;; i++){
    if(i >= NELEM(argv))
      return -1;
...
80105240:	e8 0b f4 ff ff       	call   80104650 <fetchint>
...
8010525a:	e8 21 f4 ff ff       	call   80104680 <fetchstr>
...
8010529e:	e8 dd b6 ff ff       	call   80100980 <exec>
}
...
801052b9:	8d 45 dc             	lea    -0x24(%ebp),%eax
801052bc:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
801052c3:	00 
801052c4:	89 44 24 04          	mov    %eax,0x4(%esp)
801052c8:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801052cf:	e8 3c f4 ff ff       	call   80104710 <argptr>
801052d4:	85 c0                	test   %eax,%eax
801052d6:	78 7a                	js     80105352 <sys_pipe+0xa2>
    return -1;
  if(pipealloc(&rf, &wf) < 0)
801052d8:	8d 45 e4             	lea    -0x1c(%ebp),%eax
801052db:	89 44 24 04          	mov    %eax,0x4(%esp)
801052df:	8d 45 e0             	lea    -0x20(%ebp),%eax
801052e2:	89 04 24             	mov    %eax,(%esp)
801052e5:	e8 c6 df ff ff       	call   801032b0 <pipealloc>
801052ea:	85 c0                	test   %eax,%eax
801052ec:	78 64                	js     80105352 <sys_pipe+0xa2>
801052ee:	65 8b 0d 04 00 00 00 	mov    %gs:0x4,%ecx
static int
fdalloc(struct file *f)
{
  int fd;
...
801052f7:	8b 5d e0             	mov    -0x20(%ebp),%ebx
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(proc->ofile[fd] == 0){
801052fa:	8b 54 81 28          	mov    0x28(%ecx,%eax,4),%edx
801052fe:	85 d2                	test   %edx,%edx
80105300:	74 16                	je     80105318 <sys_pipe+0x68>
...
8010530e:	74 2f                	je     8010533f <sys_pipe+0x8f>
    if(proc->ofile[fd] == 0){
80105310:	8b 54 81 28          	mov    0x28(%ecx,%eax,4),%edx
80105314:	85 d2                	test   %edx,%edx
80105316:	75 f0                	jne    80105308 <sys_pipe+0x58>
  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
    return -1;
  if(pipealloc(&rf, &wf) < 0)
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80105318:	8b 7d e4             	mov    -0x1c(%ebp),%edi
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
8010531b:	8d 70 08             	lea    0x8(%eax),%esi
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
8010531e:	31 d2                	xor    %edx,%edx
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
80105320:	89 5c b1 08          	mov    %ebx,0x8(%ecx,%esi,4)
...
fdalloc(struct file *f)
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(proc->ofile[fd] == 0){
80105328:	83 7c 91 28 00       	cmpl   $0x0,0x28(%ecx,%edx,4)
8010532d:	74 31                	je     80105360 <sys_pipe+0xb0>
static int
fdalloc(struct file *f)
{
  int fd;
...
80105332:	83 fa 10             	cmp    $0x10,%edx
80105335:	75 f1                	jne    80105328 <sys_pipe+0x78>
  if(pipealloc(&rf, &wf) < 0)
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    if(fd0 >= 0)
      proc->ofile[fd0] = 0;
80105337:	c7 44 b1 08 00 00 00 	movl   $0x0,0x8(%ecx,%esi,4)
8010533e:	00 
    fileclose(rf);
8010533f:	89 1c 24             	mov    %ebx,(%esp)
80105342:	e8 a9 ba ff ff       	call   80100df0 <fileclose>
    fileclose(wf);
80105347:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010534a:	89 04 24             	mov    %eax,(%esp)
8010534d:	e8 9e ba ff ff       	call   80100df0 <fileclose>
    return -1;
  }
  fd[0] = fd0;
  fd[1] = fd1;
...
80105352:	83 c4 2c             	add    $0x2c,%esp
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    if(fd0 >= 0)
      proc->ofile[fd0] = 0;
    fileclose(rf);
...
8010535f:	90                   	nop
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
80105360:	89 7c 91 28          	mov    %edi,0x28(%ecx,%edx,4)
      proc->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  fd[0] = fd0;
80105364:	8b 4d dc             	mov    -0x24(%ebp),%ecx
80105367:	89 01                	mov    %eax,(%ecx)
  fd[1] = fd1;
80105369:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010536c:	89 50 04             	mov    %edx,0x4(%eax)
  return 0;
}
8010536f:	83 c4 2c             	add    $0x2c,%esp
    fileclose(wf);
    return -1;
  }
  fd[0] = fd0;
...
{
  return fork();
80105384:	e9 47 e5 ff ff       	jmp    801038d0 <fork>
...
80105393:	83 ec 08             	sub    $0x8,%esp
  exit();
80105396:	e8 95 e9 ff ff       	call   80103d30 <exit>
...
{
  return wait();
801053a4:	e9 b7 eb ff ff       	jmp    80103f60 <wait>
...
801053c4:	e8 07 f3 ff ff       	call   801046d0 <argint>
...
801053d3:	e8 c8 ec ff ff       	call   801040a0 <kill>
}
801053d8:	c9                   	leave  
801053d9:	c3                   	ret    
...
return wakeall();
801053f4:	e9 97 e6 ff ff       	jmp    80103a90 <wakeall>
801053f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105400 <sys_runnable>:
...
return runnable();
80105404:	e9 37 e8 ff ff       	jmp    80103c40 <runnable>
80105409:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105410 <sys_translate>:
...
int procpid;
if(argint(0, &vaddr)<0)
80105416:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105419:	89 44 24 04          	mov    %eax,0x4(%esp)
8010541d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105424:	e8 a7 f2 ff ff       	call   801046d0 <argint>
80105429:	85 c0                	test   %eax,%eax
8010542b:	78 73                	js     801054a0 <sys_translate+0x90>
{ 
...
8010543b:	e8 90 f2 ff ff       	call   801046d0 <argint>
80105440:	85 c0                	test   %eax,%eax
80105442:	78 4c                	js     80105490 <sys_translate+0x80>
{
  cprintf("this is in sysproc.c pid<0\n");
}

cprintf("this is in sysproc.c\n");
80105444:	c7 04 24 12 77 10 80 	movl   $0x80107712,(%esp)
8010544b:	e8 d0 b1 ff ff       	call   80100620 <cprintf>
cprintf("argint vaddr is: %p\n",vaddr);
80105450:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105453:	c7 04 24 28 77 10 80 	movl   $0x80107728,(%esp)
8010545a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010545e:	e8 bd b1 ff ff       	call   80100620 <cprintf>
cprintf("argint pid is %d\n",procpid);
80105463:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105466:	c7 04 24 3d 77 10 80 	movl   $0x8010773d,(%esp)
8010546d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105471:	e8 aa b1 ff ff       	call   80100620 <cprintf>
...
80105483:	e8 68 e6 ff ff       	call   80103af0 <translate>
...
{
  cprintf("this is in sysproc.c pid<0\n");
80105490:	c7 04 24 f6 76 10 80 	movl   $0x801076f6,(%esp)
80105497:	e8 84 b1 ff ff       	call   80100620 <cprintf>
8010549c:	eb a6                	jmp    80105444 <sys_translate+0x34>
...
{ 
  cprintf("this  is in sysproc.c return-1!!\n");
801054a0:	c7 04 24 d4 76 10 80 	movl   $0x801076d4,(%esp)
...
801054e5:	e8 e6 f1 ff ff       	call   801046d0 <argint>
...
801054f4:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ...
  if(argint(0, &n) < 0)
    return -1;
  addr = proc->sz;
801054f7:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
801054f9:	89 14 24             	mov    %edx,(%esp)
801054fc:	e8 4f e3 ff ff       	call   80103850 <growproc>
80105501:	85 c0                	test   %eax,%eax
80105503:	78 0b                	js     80105510 <sys_sbrk+0x40>
    return -1;
  return addr;
80105505:	89 d8                	mov    %ebx,%eax
}
80105507:	83 c4 24             	add    $0x24,%esp
8010550a:	5b                   	pop    %ebx
8010550b:	5d                   	pop    %ebp
8010550c:	c3                   	ret    
...
80105515:	eb f0                	jmp    80105507 <sys_sbrk+0x37>
...
80105535:	e8 96 f1 ff ff       	call   801046d0 <argint>
8010553a:	85 c0                	test   %eax,%eax
8010553c:	78 7e                	js     801055bc <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
8010553e:	c7 04 24 20 38 11 80 	movl   $0x80113820,(%esp)
80105545:	e8 26 ed ff ff       	call   80104270 <acquire>
  ticks0 = ticks;
...
8010554a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ...
  acquire(&tickslock);
  ticks0 = ticks;
8010554d:	8b 1d 60 40 11 80    	mov    0x80114060,%ebx
  while(ticks - ticks0 < n){
...
80105560:	c7 44 24 04 20 38 11 	movl   $0x80113820,0x4(%esp)
80105567:	80 
80105568:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
8010556f:	e8 2c e9 ff ff       	call   80103ea0 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105574:	a1 60 40 11 80       	mov    0x80114060,%eax
...
8010558b:	74 d3                	je     80105560 <sys_sleep+0x40>
      release(&tickslock);
8010558d:	c7 04 24 20 38 11 80 	movl   $0x80113820,(%esp)
80105594:	e8 07 ee ff ff       	call   801043a0 <release>
      return -1;
...
801055a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  release(&tickslock);
801055a8:	c7 04 24 20 38 11 80 	movl   $0x80113820,(%esp)
801055af:	e8 ec ed ff ff       	call   801043a0 <release>
  return 0;
}
...
801055c1:	eb db                	jmp    8010559e <sys_sleep+0x7e>
...
801055d4:	83 ec 14             	sub    $0x14,%esp
  ...
  acquire(&tickslock);
801055d7:	c7 04 24 20 38 11 80 	movl   $0x80113820,(%esp)
801055de:	e8 8d ec ff ff       	call   80104270 <acquire>
  xticks = ticks;
801055e3:	8b 1d 60 40 11 80    	mov    0x80114060,%ebx
  release(&tickslock);
801055e9:	c7 04 24 20 38 11 80 	movl   $0x80113820,(%esp)
801055f0:	e8 ab ed ff ff       	call   801043a0 <release>
  return xticks;
}
...
80105631:	06                   	push   %es
  pushl %fs
80105632:	0f a0                	push   %fs
  pushl %gs
80105634:	0f a8                	push   %gs
  pushal
80105636:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
80105637:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010563b:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010563d:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
8010563f:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
80105643:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
80105645:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
80105647:	54                   	push   %esp
  call trap
80105648:	e8 e3 00 00 00       	call   80105730 <trap>
  addl $4, %esp
8010564d:	83 c4 04             	add    $0x4,%esp
...
80105650:	61                   	popa   
  popl %gs
80105651:	0f a9                	pop    %gs
  popl %fs
80105653:	0f a1                	pop    %fs
  popl %es
80105655:	07                   	pop    %es
  popl %ds
80105656:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105657:	83 c4 08             	add    $0x8,%esp
  iret
8010565a:	cf                   	iret   
...
80105674:	66 89 0c c5 62 38 11 	mov    %cx,-0x7feec79e(,%eax,8)
8010567b:	80 
8010567c:	c6 04 c5 64 38 11 80 	movb   $0x0,-0x7feec79c(,%eax,8)
80105683:	00 
80105684:	c6 04 c5 65 38 11 80 	movb   $0x8e,-0x7feec79b(,%eax,8)
8010568b:	8e 
8010568c:	66 89 14 c5 60 38 11 	mov    %dx,-0x7feec7a0(,%eax,8)
80105693:	80 
80105694:	c1 ea 10             	shr    $0x10,%edx
80105697:	66 89 14 c5 66 38 11 	mov    %dx,-0x7feec79a(,%eax,8)
8010569e:	80 
void
tvinit(void)
{
...
801056b9:	c7 44 24 04 4f 77 10 	movl   $0x8010774f,0x4(%esp)
801056c0:	80 
801056c1:	c7 04 24 20 38 11 80 	movl   $0x80113820,(%esp)
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801056c8:	66 89 15 62 3a 11 80 	mov    %dx,0x80113a62
801056cf:	66 a3 60 3a 11 80    	mov    %ax,0x80113a60
801056d5:	c1 e8 10             	shr    $0x10,%eax
801056d8:	c6 05 64 3a 11 80 00 	movb   $0x0,0x80113a64
801056df:	c6 05 65 3a 11 80 ef 	movb   $0xef,0x80113a65
801056e6:	66 a3 66 3a 11 80    	mov    %ax,0x80113a66

  initlock(&tickslock, "time");
801056ec:	e8 ff ea ff ff       	call   801041f0 <initlock>
}
801056f1:	c9                   	leave  
801056f2:	c3                   	ret    
...
8010570b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010570f:	b8 60 38 11 80       	mov    $0x80113860,%eax
...
80105750:	ff 24 85 f8 77 10 80 	jmp    *-0x7fef8808(,%eax,4)
80105757:	90                   	nop
...
801057ff:	c7 04 24 b4 77 10 80 	movl   $0x801077b4,(%esp)
80105806:	89 44 24 04          	mov    %eax,0x4(%esp)
8010580a:	e8 11 ae ff ff       	call   80100620 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpunum(), tf->eip,
            rcr2());
    proc->killed = 1;
...
80105827:	0f 85 53 ff ff ff    	jne    80105780 <trap+0x50>
    exit();
8010582d:	e8 fe e4 ff ff       	call   80103d30 <exit>
...
80105859:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
8010585c:	e8 7f ef ff ff       	call   801047e0 <syscall>
    if(proc->killed)
...
80105878:	5d                   	pop    %ebp
    ...
    if(proc->killed)
      exit();
80105879:	e9 b2 e4 ff ff       	jmp    80103d30 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(proc->killed)
      exit();
80105900:	e8 2b e4 ff ff       	call   80103d30 <exit>
...
80105914:	0f 85 70 fe ff ff    	jne    8010578a <trap+0x5a>
    yield();
8010591a:	e8 41 e5 ff ff       	call   80103e60 <yield>
...
80105932:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpunum() == 0){
      acquire(&tickslock);
80105938:	c7 04 24 20 38 11 80 	movl   $0x80113820,(%esp)
8010593f:	e8 2c e9 ff ff       	call   80104270 <acquire>
      ticks++;
      wakeup(&ticks);
80105944:	c7 04 24 60 40 11 80 	movl   $0x80114060,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpunum() == 0){
      acquire(&tickslock);
      ticks++;
8010594b:	83 05 60 40 11 80 01 	addl   $0x1,0x80114060
      wakeup(&ticks);
80105952:	e8 e9 e6 ff ff       	call   80104040 <wakeup>
      release(&tickslock);
80105957:	c7 04 24 20 38 11 80 	movl   $0x80113820,(%esp)
8010595e:	e8 3d ea ff ff       	call   801043a0 <release>
...
80105982:	c7 04 24 80 77 10 80 	movl   $0x80107780,(%esp)
80105989:	89 44 24 04          	mov    %eax,0x4(%esp)
8010598d:	e8 8e ac ff ff       	call   80100620 <cprintf>
              tf->trapno, cpunum(), tf->eip, rcr2());
      panic("trap");
80105992:	c7 04 24 54 77 10 80 	movl   $0x80107754,(%esp)
80105999:	e8 92 a9 ff ff       	call   80100330 <panic>
...
80105a80:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
  ...
  for(p="xv6...\n"; *p; p++)
80105a87:	bb 78 78 10 80       	mov    $0x80107878,%ebx
...
80105add:	e8 9e ac ff ff       	call   80100780 <consoleintr>
}
80105ae2:	c9                   	leave  
80105ae3:	c3                   	ret    
...
80105ae6:	6a 00                	push   $0x0
  jmp alltraps
80105ae8:	e9 43 fb ff ff       	jmp    80105630 <alltraps>
...
80105aef:	6a 01                	push   $0x1
  jmp alltraps
80105af1:	e9 3a fb ff ff       	jmp    80105630 <alltraps>
...
80105af8:	6a 02                	push   $0x2
  jmp alltraps
80105afa:	e9 31 fb ff ff       	jmp    80105630 <alltraps>
...
80105b01:	6a 03                	push   $0x3
  jmp alltraps
80105b03:	e9 28 fb ff ff       	jmp    80105630 <alltraps>
...
80105b0a:	6a 04                	push   $0x4
  jmp alltraps
80105b0c:	e9 1f fb ff ff       	jmp    80105630 <alltraps>
...
80105b13:	6a 05                	push   $0x5
  jmp alltraps
80105b15:	e9 16 fb ff ff       	jmp    80105630 <alltraps>
...
80105b1c:	6a 06                	push   $0x6
  jmp alltraps
80105b1e:	e9 0d fb ff ff       	jmp    80105630 <alltraps>
...
80105b25:	6a 07                	push   $0x7
  jmp alltraps
80105b27:	e9 04 fb ff ff       	jmp    80105630 <alltraps>
...
80105b2c:	6a 08                	push   $0x8
  jmp alltraps
80105b2e:	e9 fd fa ff ff       	jmp    80105630 <alltraps>
...
80105b35:	6a 09                	push   $0x9
  jmp alltraps
80105b37:	e9 f4 fa ff ff       	jmp    80105630 <alltraps>
...
80105b3c:	6a 0a                	push   $0xa
  jmp alltraps
80105b3e:	e9 ed fa ff ff       	jmp    80105630 <alltraps>
...
80105b43:	6a 0b                	push   $0xb
  jmp alltraps
80105b45:	e9 e6 fa ff ff       	jmp    80105630 <alltraps>
...
80105b4a:	6a 0c                	push   $0xc
  jmp alltraps
80105b4c:	e9 df fa ff ff       	jmp    80105630 <alltraps>
...
80105b51:	6a 0d                	push   $0xd
  jmp alltraps
80105b53:	e9 d8 fa ff ff       	jmp    80105630 <alltraps>
...
80105b58:	6a 0e                	push   $0xe
  jmp alltraps
80105b5a:	e9 d1 fa ff ff       	jmp    80105630 <alltraps>
...
80105b61:	6a 0f                	push   $0xf
  jmp alltraps
80105b63:	e9 c8 fa ff ff       	jmp    80105630 <alltraps>
...
80105b6a:	6a 10                	push   $0x10
  jmp alltraps
80105b6c:	e9 bf fa ff ff       	jmp    80105630 <alltraps>
...
80105b71:	6a 11                	push   $0x11
  jmp alltraps
80105b73:	e9 b8 fa ff ff       	jmp    80105630 <alltraps>
...
80105b7a:	6a 12                	push   $0x12
  jmp alltraps
80105b7c:	e9 af fa ff ff       	jmp    80105630 <alltraps>
...
80105b83:	6a 13                	push   $0x13
  jmp alltraps
80105b85:	e9 a6 fa ff ff       	jmp    80105630 <alltraps>
...
80105b8c:	6a 14                	push   $0x14
  jmp alltraps
80105b8e:	e9 9d fa ff ff       	jmp    80105630 <alltraps>
...
80105b95:	6a 15                	push   $0x15
  jmp alltraps
80105b97:	e9 94 fa ff ff       	jmp    80105630 <alltraps>
...
80105b9e:	6a 16                	push   $0x16
  jmp alltraps
80105ba0:	e9 8b fa ff ff       	jmp    80105630 <alltraps>
...
80105ba7:	6a 17                	push   $0x17
  jmp alltraps
80105ba9:	e9 82 fa ff ff       	jmp    80105630 <alltraps>
...
80105bb0:	6a 18                	push   $0x18
  jmp alltraps
80105bb2:	e9 79 fa ff ff       	jmp    80105630 <alltraps>
...
80105bb9:	6a 19                	push   $0x19
  jmp alltraps
80105bbb:	e9 70 fa ff ff       	jmp    80105630 <alltraps>
...
80105bc2:	6a 1a                	push   $0x1a
  jmp alltraps
80105bc4:	e9 67 fa ff ff       	jmp    80105630 <alltraps>
...
80105bcb:	6a 1b                	push   $0x1b
  jmp alltraps
80105bcd:	e9 5e fa ff ff       	jmp    80105630 <alltraps>
...
80105bd4:	6a 1c                	push   $0x1c
  jmp alltraps
80105bd6:	e9 55 fa ff ff       	jmp    80105630 <alltraps>
...
80105bdd:	6a 1d                	push   $0x1d
  jmp alltraps
80105bdf:	e9 4c fa ff ff       	jmp    80105630 <alltraps>
...
80105be6:	6a 1e                	push   $0x1e
  jmp alltraps
80105be8:	e9 43 fa ff ff       	jmp    80105630 <alltraps>
...
80105bef:	6a 1f                	push   $0x1f
  jmp alltraps
80105bf1:	e9 3a fa ff ff       	jmp    80105630 <alltraps>
...
80105bf8:	6a 20                	push   $0x20
  jmp alltraps
80105bfa:	e9 31 fa ff ff       	jmp    80105630 <alltraps>
...
80105c01:	6a 21                	push   $0x21
  jmp alltraps
80105c03:	e9 28 fa ff ff       	jmp    80105630 <alltraps>
...
80105c0a:	6a 22                	push   $0x22
  jmp alltraps
80105c0c:	e9 1f fa ff ff       	jmp    80105630 <alltraps>
...
80105c13:	6a 23                	push   $0x23
  jmp alltraps
80105c15:	e9 16 fa ff ff       	jmp    80105630 <alltraps>
...
80105c1c:	6a 24                	push   $0x24
  jmp alltraps
80105c1e:	e9 0d fa ff ff       	jmp    80105630 <alltraps>
...
80105c25:	6a 25                	push   $0x25
  jmp alltraps
80105c27:	e9 04 fa ff ff       	jmp    80105630 <alltraps>
...
80105c2e:	6a 26                	push   $0x26
  jmp alltraps
80105c30:	e9 fb f9 ff ff       	jmp    80105630 <alltraps>
...
80105c37:	6a 27                	push   $0x27
  jmp alltraps
80105c39:	e9 f2 f9 ff ff       	jmp    80105630 <alltraps>
...
80105c40:	6a 28                	push   $0x28
  jmp alltraps
80105c42:	e9 e9 f9 ff ff       	jmp    80105630 <alltraps>
...
80105c49:	6a 29                	push   $0x29
  jmp alltraps
80105c4b:	e9 e0 f9 ff ff       	jmp    80105630 <alltraps>
...
80105c52:	6a 2a                	push   $0x2a
  jmp alltraps
80105c54:	e9 d7 f9 ff ff       	jmp    80105630 <alltraps>
...
80105c5b:	6a 2b                	push   $0x2b
  jmp alltraps
80105c5d:	e9 ce f9 ff ff       	jmp    80105630 <alltraps>
...
80105c64:	6a 2c                	push   $0x2c
  jmp alltraps
80105c66:	e9 c5 f9 ff ff       	jmp    80105630 <alltraps>
...
80105c6d:	6a 2d                	push   $0x2d
  jmp alltraps
80105c6f:	e9 bc f9 ff ff       	jmp    80105630 <alltraps>
...
80105c76:	6a 2e                	push   $0x2e
  jmp alltraps
80105c78:	e9 b3 f9 ff ff       	jmp    80105630 <alltraps>
...
80105c7f:	6a 2f                	push   $0x2f
  jmp alltraps
80105c81:	e9 aa f9 ff ff       	jmp    80105630 <alltraps>
...
80105c88:	6a 30                	push   $0x30
  jmp alltraps
80105c8a:	e9 a1 f9 ff ff       	jmp    80105630 <alltraps>
...
80105c91:	6a 31                	push   $0x31
  jmp alltraps
80105c93:	e9 98 f9 ff ff       	jmp    80105630 <alltraps>
...
80105c9a:	6a 32                	push   $0x32
  jmp alltraps
80105c9c:	e9 8f f9 ff ff       	jmp    80105630 <alltraps>
...
80105ca3:	6a 33                	push   $0x33
  jmp alltraps
80105ca5:	e9 86 f9 ff ff       	jmp    80105630 <alltraps>
...
80105cac:	6a 34                	push   $0x34
  jmp alltraps
80105cae:	e9 7d f9 ff ff       	jmp    80105630 <alltraps>
...
80105cb5:	6a 35                	push   $0x35
  jmp alltraps
80105cb7:	e9 74 f9 ff ff       	jmp    80105630 <alltraps>
...
80105cbe:	6a 36                	push   $0x36
  jmp alltraps
80105cc0:	e9 6b f9 ff ff       	jmp    80105630 <alltraps>
...
80105cc7:	6a 37                	push   $0x37
  jmp alltraps
80105cc9:	e9 62 f9 ff ff       	jmp    80105630 <alltraps>
...
80105cd0:	6a 38                	push   $0x38
  jmp alltraps
80105cd2:	e9 59 f9 ff ff       	jmp    80105630 <alltraps>
...
80105cd9:	6a 39                	push   $0x39
  jmp alltraps
80105cdb:	e9 50 f9 ff ff       	jmp    80105630 <alltraps>
...
80105ce2:	6a 3a                	push   $0x3a
  jmp alltraps
80105ce4:	e9 47 f9 ff ff       	jmp    80105630 <alltraps>
...
80105ceb:	6a 3b                	push   $0x3b
  jmp alltraps
80105ced:	e9 3e f9 ff ff       	jmp    80105630 <alltraps>
...
80105cf4:	6a 3c                	push   $0x3c
  jmp alltraps
80105cf6:	e9 35 f9 ff ff       	jmp    80105630 <alltraps>
...
80105cfd:	6a 3d                	push   $0x3d
  jmp alltraps
80105cff:	e9 2c f9 ff ff       	jmp    80105630 <alltraps>
...
80105d06:	6a 3e                	push   $0x3e
  jmp alltraps
80105d08:	e9 23 f9 ff ff       	jmp    80105630 <alltraps>
...
80105d0f:	6a 3f                	push   $0x3f
  jmp alltraps
80105d11:	e9 1a f9 ff ff       	jmp    80105630 <alltraps>
...
80105d18:	6a 40                	push   $0x40
  jmp alltraps
80105d1a:	e9 11 f9 ff ff       	jmp    80105630 <alltraps>
...
80105d21:	6a 41                	push   $0x41
  jmp alltraps
80105d23:	e9 08 f9 ff ff       	jmp    80105630 <alltraps>
...
80105d2a:	6a 42                	push   $0x42
  jmp alltraps
80105d2c:	e9 ff f8 ff ff       	jmp    80105630 <alltraps>
...
80105d33:	6a 43                	push   $0x43
  jmp alltraps
80105d35:	e9 f6 f8 ff ff       	jmp    80105630 <alltraps>
...
80105d3c:	6a 44                	push   $0x44
  jmp alltraps
80105d3e:	e9 ed f8 ff ff       	jmp    80105630 <alltraps>
...
80105d45:	6a 45                	push   $0x45
  jmp alltraps
80105d47:	e9 e4 f8 ff ff       	jmp    80105630 <alltraps>
...
80105d4e:	6a 46                	push   $0x46
  jmp alltraps
80105d50:	e9 db f8 ff ff       	jmp    80105630 <alltraps>
...
80105d57:	6a 47                	push   $0x47
  jmp alltraps
80105d59:	e9 d2 f8 ff ff       	jmp    80105630 <alltraps>
...
80105d60:	6a 48                	push   $0x48
  jmp alltraps
80105d62:	e9 c9 f8 ff ff       	jmp    80105630 <alltraps>
...
80105d69:	6a 49                	push   $0x49
  jmp alltraps
80105d6b:	e9 c0 f8 ff ff       	jmp    80105630 <alltraps>
...
80105d72:	6a 4a                	push   $0x4a
  jmp alltraps
80105d74:	e9 b7 f8 ff ff       	jmp    80105630 <alltraps>
...
80105d7b:	6a 4b                	push   $0x4b
  jmp alltraps
80105d7d:	e9 ae f8 ff ff       	jmp    80105630 <alltraps>
...
80105d84:	6a 4c                	push   $0x4c
  jmp alltraps
80105d86:	e9 a5 f8 ff ff       	jmp    80105630 <alltraps>
...
80105d8d:	6a 4d                	push   $0x4d
  jmp alltraps
80105d8f:	e9 9c f8 ff ff       	jmp    80105630 <alltraps>
...
80105d96:	6a 4e                	push   $0x4e
  jmp alltraps
80105d98:	e9 93 f8 ff ff       	jmp    80105630 <alltraps>
...
80105d9f:	6a 4f                	push   $0x4f
  jmp alltraps
80105da1:	e9 8a f8 ff ff       	jmp    80105630 <alltraps>
...
80105da8:	6a 50                	push   $0x50
  jmp alltraps
80105daa:	e9 81 f8 ff ff       	jmp    80105630 <alltraps>
...
80105db1:	6a 51                	push   $0x51
  jmp alltraps
80105db3:	e9 78 f8 ff ff       	jmp    80105630 <alltraps>
...
80105dba:	6a 52                	push   $0x52
  jmp alltraps
80105dbc:	e9 6f f8 ff ff       	jmp    80105630 <alltraps>
...
80105dc3:	6a 53                	push   $0x53
  jmp alltraps
80105dc5:	e9 66 f8 ff ff       	jmp    80105630 <alltraps>
...
80105dcc:	6a 54                	push   $0x54
  jmp alltraps
80105dce:	e9 5d f8 ff ff       	jmp    80105630 <alltraps>
...
80105dd5:	6a 55                	push   $0x55
  jmp alltraps
80105dd7:	e9 54 f8 ff ff       	jmp    80105630 <alltraps>
...
80105dde:	6a 56                	push   $0x56
  jmp alltraps
80105de0:	e9 4b f8 ff ff       	jmp    80105630 <alltraps>
...
80105de7:	6a 57                	push   $0x57
  jmp alltraps
80105de9:	e9 42 f8 ff ff       	jmp    80105630 <alltraps>
...
80105df0:	6a 58                	push   $0x58
  jmp alltraps
80105df2:	e9 39 f8 ff ff       	jmp    80105630 <alltraps>
...
80105df9:	6a 59                	push   $0x59
  jmp alltraps
80105dfb:	e9 30 f8 ff ff       	jmp    80105630 <alltraps>
...
80105e02:	6a 5a                	push   $0x5a
  jmp alltraps
80105e04:	e9 27 f8 ff ff       	jmp    80105630 <alltraps>
...
80105e0b:	6a 5b                	push   $0x5b
  jmp alltraps
80105e0d:	e9 1e f8 ff ff       	jmp    80105630 <alltraps>
...
80105e14:	6a 5c                	push   $0x5c
  jmp alltraps
80105e16:	e9 15 f8 ff ff       	jmp    80105630 <alltraps>
...
80105e1d:	6a 5d                	push   $0x5d
  jmp alltraps
80105e1f:	e9 0c f8 ff ff       	jmp    80105630 <alltraps>
...
80105e26:	6a 5e                	push   $0x5e
  jmp alltraps
80105e28:	e9 03 f8 ff ff       	jmp    80105630 <alltraps>
...
80105e2f:	6a 5f                	push   $0x5f
  jmp alltraps
80105e31:	e9 fa f7 ff ff       	jmp    80105630 <alltraps>
...
80105e38:	6a 60                	push   $0x60
  jmp alltraps
80105e3a:	e9 f1 f7 ff ff       	jmp    80105630 <alltraps>
...
80105e41:	6a 61                	push   $0x61
  jmp alltraps
80105e43:	e9 e8 f7 ff ff       	jmp    80105630 <alltraps>
...
80105e4a:	6a 62                	push   $0x62
  jmp alltraps
80105e4c:	e9 df f7 ff ff       	jmp    80105630 <alltraps>
...
80105e53:	6a 63                	push   $0x63
  jmp alltraps
80105e55:	e9 d6 f7 ff ff       	jmp    80105630 <alltraps>
...
80105e5c:	6a 64                	push   $0x64
  jmp alltraps
80105e5e:	e9 cd f7 ff ff       	jmp    80105630 <alltraps>
...
80105e65:	6a 65                	push   $0x65
  jmp alltraps
80105e67:	e9 c4 f7 ff ff       	jmp    80105630 <alltraps>
...
80105e6e:	6a 66                	push   $0x66
  jmp alltraps
80105e70:	e9 bb f7 ff ff       	jmp    80105630 <alltraps>
...
80105e77:	6a 67                	push   $0x67
  jmp alltraps
80105e79:	e9 b2 f7 ff ff       	jmp    80105630 <alltraps>
...
80105e80:	6a 68                	push   $0x68
  jmp alltraps
80105e82:	e9 a9 f7 ff ff       	jmp    80105630 <alltraps>
...
80105e89:	6a 69                	push   $0x69
  jmp alltraps
80105e8b:	e9 a0 f7 ff ff       	jmp    80105630 <alltraps>
...
80105e92:	6a 6a                	push   $0x6a
  jmp alltraps
80105e94:	e9 97 f7 ff ff       	jmp    80105630 <alltraps>
...
80105e9b:	6a 6b                	push   $0x6b
  jmp alltraps
80105e9d:	e9 8e f7 ff ff       	jmp    80105630 <alltraps>
...
80105ea4:	6a 6c                	push   $0x6c
  jmp alltraps
80105ea6:	e9 85 f7 ff ff       	jmp    80105630 <alltraps>
...
80105ead:	6a 6d                	push   $0x6d
  jmp alltraps
80105eaf:	e9 7c f7 ff ff       	jmp    80105630 <alltraps>
...
80105eb6:	6a 6e                	push   $0x6e
  jmp alltraps
80105eb8:	e9 73 f7 ff ff       	jmp    80105630 <alltraps>
...
80105ebf:	6a 6f                	push   $0x6f
  jmp alltraps
80105ec1:	e9 6a f7 ff ff       	jmp    80105630 <alltraps>
...
80105ec8:	6a 70                	push   $0x70
  jmp alltraps
80105eca:	e9 61 f7 ff ff       	jmp    80105630 <alltraps>
...
80105ed1:	6a 71                	push   $0x71
  jmp alltraps
80105ed3:	e9 58 f7 ff ff       	jmp    80105630 <alltraps>
...
80105eda:	6a 72                	push   $0x72
  jmp alltraps
80105edc:	e9 4f f7 ff ff       	jmp    80105630 <alltraps>
...
80105ee3:	6a 73                	push   $0x73
  jmp alltraps
80105ee5:	e9 46 f7 ff ff       	jmp    80105630 <alltraps>
...
80105eec:	6a 74                	push   $0x74
  jmp alltraps
80105eee:	e9 3d f7 ff ff       	jmp    80105630 <alltraps>
...
80105ef5:	6a 75                	push   $0x75
  jmp alltraps
80105ef7:	e9 34 f7 ff ff       	jmp    80105630 <alltraps>
...
80105efe:	6a 76                	push   $0x76
  jmp alltraps
80105f00:	e9 2b f7 ff ff       	jmp    80105630 <alltraps>
...
80105f07:	6a 77                	push   $0x77
  jmp alltraps
80105f09:	e9 22 f7 ff ff       	jmp    80105630 <alltraps>
...
80105f10:	6a 78                	push   $0x78
  jmp alltraps
80105f12:	e9 19 f7 ff ff       	jmp    80105630 <alltraps>
...
80105f19:	6a 79                	push   $0x79
  jmp alltraps
80105f1b:	e9 10 f7 ff ff       	jmp    80105630 <alltraps>
...
80105f22:	6a 7a                	push   $0x7a
  jmp alltraps
80105f24:	e9 07 f7 ff ff       	jmp    80105630 <alltraps>
...
80105f2b:	6a 7b                	push   $0x7b
  jmp alltraps
80105f2d:	e9 fe f6 ff ff       	jmp    80105630 <alltraps>
...
80105f34:	6a 7c                	push   $0x7c
  jmp alltraps
80105f36:	e9 f5 f6 ff ff       	jmp    80105630 <alltraps>
...
80105f3d:	6a 7d                	push   $0x7d
  jmp alltraps
80105f3f:	e9 ec f6 ff ff       	jmp    80105630 <alltraps>
...
80105f46:	6a 7e                	push   $0x7e
  jmp alltraps
80105f48:	e9 e3 f6 ff ff       	jmp    80105630 <alltraps>
...
80105f4f:	6a 7f                	push   $0x7f
  jmp alltraps
80105f51:	e9 da f6 ff ff       	jmp    80105630 <alltraps>
...
80105f58:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105f5d:	e9 ce f6 ff ff       	jmp    80105630 <alltraps>
...
80105f64:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105f69:	e9 c2 f6 ff ff       	jmp    80105630 <alltraps>
...
80105f70:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105f75:	e9 b6 f6 ff ff       	jmp    80105630 <alltraps>
...
80105f7c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105f81:	e9 aa f6 ff ff       	jmp    80105630 <alltraps>
...
80105f88:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105f8d:	e9 9e f6 ff ff       	jmp    80105630 <alltraps>
...
80105f94:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105f99:	e9 92 f6 ff ff       	jmp    80105630 <alltraps>
...
80105fa0:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80105fa5:	e9 86 f6 ff ff       	jmp    80105630 <alltraps>
...
80105fac:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105fb1:	e9 7a f6 ff ff       	jmp    80105630 <alltraps>
...
80105fb8:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105fbd:	e9 6e f6 ff ff       	jmp    80105630 <alltraps>
...
80105fc4:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105fc9:	e9 62 f6 ff ff       	jmp    80105630 <alltraps>
...
80105fd0:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80105fd5:	e9 56 f6 ff ff       	jmp    80105630 <alltraps>
...
80105fdc:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105fe1:	e9 4a f6 ff ff       	jmp    80105630 <alltraps>
...
80105fe8:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105fed:	e9 3e f6 ff ff       	jmp    80105630 <alltraps>
...
80105ff4:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105ff9:	e9 32 f6 ff ff       	jmp    80105630 <alltraps>
...
80106000:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106005:	e9 26 f6 ff ff       	jmp    80105630 <alltraps>
...
8010600c:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106011:	e9 1a f6 ff ff       	jmp    80105630 <alltraps>
...
80106018:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010601d:	e9 0e f6 ff ff       	jmp    80105630 <alltraps>
...
80106024:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106029:	e9 02 f6 ff ff       	jmp    80105630 <alltraps>
...
80106030:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106035:	e9 f6 f5 ff ff       	jmp    80105630 <alltraps>
...
8010603c:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106041:	e9 ea f5 ff ff       	jmp    80105630 <alltraps>
...
80106048:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010604d:	e9 de f5 ff ff       	jmp    80105630 <alltraps>
...
80106054:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106059:	e9 d2 f5 ff ff       	jmp    80105630 <alltraps>
...
80106060:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106065:	e9 c6 f5 ff ff       	jmp    80105630 <alltraps>
...
8010606c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106071:	e9 ba f5 ff ff       	jmp    80105630 <alltraps>
...
80106078:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010607d:	e9 ae f5 ff ff       	jmp    80105630 <alltraps>
...
80106084:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80106089:	e9 a2 f5 ff ff       	jmp    80105630 <alltraps>
...
80106090:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106095:	e9 96 f5 ff ff       	jmp    80105630 <alltraps>
...
8010609c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801060a1:	e9 8a f5 ff ff       	jmp    80105630 <alltraps>
...
801060a8:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801060ad:	e9 7e f5 ff ff       	jmp    80105630 <alltraps>
...
801060b4:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801060b9:	e9 72 f5 ff ff       	jmp    80105630 <alltraps>
...
801060c0:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801060c5:	e9 66 f5 ff ff       	jmp    80105630 <alltraps>
...
801060cc:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801060d1:	e9 5a f5 ff ff       	jmp    80105630 <alltraps>
...
801060d8:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801060dd:	e9 4e f5 ff ff       	jmp    80105630 <alltraps>
...
801060e4:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801060e9:	e9 42 f5 ff ff       	jmp    80105630 <alltraps>
...
801060f0:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801060f5:	e9 36 f5 ff ff       	jmp    80105630 <alltraps>
...
801060fc:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106101:	e9 2a f5 ff ff       	jmp    80105630 <alltraps>
...
80106108:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010610d:	e9 1e f5 ff ff       	jmp    80105630 <alltraps>
...
80106114:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80106119:	e9 12 f5 ff ff       	jmp    80105630 <alltraps>
...
80106120:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106125:	e9 06 f5 ff ff       	jmp    80105630 <alltraps>
...
8010612c:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106131:	e9 fa f4 ff ff       	jmp    80105630 <alltraps>
...
80106138:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010613d:	e9 ee f4 ff ff       	jmp    80105630 <alltraps>
...
80106144:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80106149:	e9 e2 f4 ff ff       	jmp    80105630 <alltraps>
...
80106150:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106155:	e9 d6 f4 ff ff       	jmp    80105630 <alltraps>
...
8010615c:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106161:	e9 ca f4 ff ff       	jmp    80105630 <alltraps>
...
80106168:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010616d:	e9 be f4 ff ff       	jmp    80105630 <alltraps>
...
80106174:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106179:	e9 b2 f4 ff ff       	jmp    80105630 <alltraps>
...
80106180:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106185:	e9 a6 f4 ff ff       	jmp    80105630 <alltraps>
...
8010618c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106191:	e9 9a f4 ff ff       	jmp    80105630 <alltraps>
...
80106198:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010619d:	e9 8e f4 ff ff       	jmp    80105630 <alltraps>
...
801061a4:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801061a9:	e9 82 f4 ff ff       	jmp    80105630 <alltraps>
...
801061b0:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801061b5:	e9 76 f4 ff ff       	jmp    80105630 <alltraps>
...
801061bc:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801061c1:	e9 6a f4 ff ff       	jmp    80105630 <alltraps>
...
801061c8:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801061cd:	e9 5e f4 ff ff       	jmp    80105630 <alltraps>
...
801061d4:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801061d9:	e9 52 f4 ff ff       	jmp    80105630 <alltraps>
...
801061e0:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801061e5:	e9 46 f4 ff ff       	jmp    80105630 <alltraps>
...
801061ec:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801061f1:	e9 3a f4 ff ff       	jmp    80105630 <alltraps>
...
801061f8:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801061fd:	e9 2e f4 ff ff       	jmp    80105630 <alltraps>
...
80106204:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106209:	e9 22 f4 ff ff       	jmp    80105630 <alltraps>
...
80106210:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106215:	e9 16 f4 ff ff       	jmp    80105630 <alltraps>
...
8010621c:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106221:	e9 0a f4 ff ff       	jmp    80105630 <alltraps>
...
80106228:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010622d:	e9 fe f3 ff ff       	jmp    80105630 <alltraps>
...
80106234:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106239:	e9 f2 f3 ff ff       	jmp    80105630 <alltraps>
...
80106240:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106245:	e9 e6 f3 ff ff       	jmp    80105630 <alltraps>
...
8010624c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106251:	e9 da f3 ff ff       	jmp    80105630 <alltraps>
...
80106258:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010625d:	e9 ce f3 ff ff       	jmp    80105630 <alltraps>
...
80106264:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106269:	e9 c2 f3 ff ff       	jmp    80105630 <alltraps>
...
80106270:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106275:	e9 b6 f3 ff ff       	jmp    80105630 <alltraps>
...
8010627c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106281:	e9 aa f3 ff ff       	jmp    80105630 <alltraps>
...
80106288:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010628d:	e9 9e f3 ff ff       	jmp    80105630 <alltraps>
...
80106294:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106299:	e9 92 f3 ff ff       	jmp    80105630 <alltraps>
...
801062a0:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801062a5:	e9 86 f3 ff ff       	jmp    80105630 <alltraps>
...
801062ac:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801062b1:	e9 7a f3 ff ff       	jmp    80105630 <alltraps>
...
801062b8:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801062bd:	e9 6e f3 ff ff       	jmp    80105630 <alltraps>
...
801062c4:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801062c9:	e9 62 f3 ff ff       	jmp    80105630 <alltraps>
...
801062d0:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801062d5:	e9 56 f3 ff ff       	jmp    80105630 <alltraps>
...
801062dc:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801062e1:	e9 4a f3 ff ff       	jmp    80105630 <alltraps>
...
801062e8:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801062ed:	e9 3e f3 ff ff       	jmp    80105630 <alltraps>
...
801062f4:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801062f9:	e9 32 f3 ff ff       	jmp    80105630 <alltraps>
...
80106300:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106305:	e9 26 f3 ff ff       	jmp    80105630 <alltraps>
...
8010630c:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106311:	e9 1a f3 ff ff       	jmp    80105630 <alltraps>
...
80106318:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010631d:	e9 0e f3 ff ff       	jmp    80105630 <alltraps>
...
80106324:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106329:	e9 02 f3 ff ff       	jmp    80105630 <alltraps>
...
80106330:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106335:	e9 f6 f2 ff ff       	jmp    80105630 <alltraps>
...
8010633c:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106341:	e9 ea f2 ff ff       	jmp    80105630 <alltraps>
...
80106348:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010634d:	e9 de f2 ff ff       	jmp    80105630 <alltraps>
...
80106354:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106359:	e9 d2 f2 ff ff       	jmp    80105630 <alltraps>
...
80106360:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106365:	e9 c6 f2 ff ff       	jmp    80105630 <alltraps>
...
8010636c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106371:	e9 ba f2 ff ff       	jmp    80105630 <alltraps>
...
80106378:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010637d:	e9 ae f2 ff ff       	jmp    80105630 <alltraps>
...
80106384:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106389:	e9 a2 f2 ff ff       	jmp    80105630 <alltraps>
...
80106390:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106395:	e9 96 f2 ff ff       	jmp    80105630 <alltraps>
...
8010639c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801063a1:	e9 8a f2 ff ff       	jmp    80105630 <alltraps>
...
801063a8:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801063ad:	e9 7e f2 ff ff       	jmp    80105630 <alltraps>
...
801063b4:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801063b9:	e9 72 f2 ff ff       	jmp    80105630 <alltraps>
...
801063c0:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801063c5:	e9 66 f2 ff ff       	jmp    80105630 <alltraps>
...
801063cc:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801063d1:	e9 5a f2 ff ff       	jmp    80105630 <alltraps>
...
801063d8:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801063dd:	e9 4e f2 ff ff       	jmp    80105630 <alltraps>
...
801063e4:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801063e9:	e9 42 f2 ff ff       	jmp    80105630 <alltraps>
...
801063f0:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801063f5:	e9 36 f2 ff ff       	jmp    80105630 <alltraps>
...
801063fc:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106401:	e9 2a f2 ff ff       	jmp    80105630 <alltraps>
...
80106408:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010640d:	e9 1e f2 ff ff       	jmp    80105630 <alltraps>
...
80106414:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106419:	e9 12 f2 ff ff       	jmp    80105630 <alltraps>
...
80106420:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106425:	e9 06 f2 ff ff       	jmp    80105630 <alltraps>
...
8010642c:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106431:	e9 fa f1 ff ff       	jmp    80105630 <alltraps>
...
80106438:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010643d:	e9 ee f1 ff ff       	jmp    80105630 <alltraps>
...
80106444:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106449:	e9 e2 f1 ff ff       	jmp    80105630 <alltraps>
...
80106450:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106455:	e9 d6 f1 ff ff       	jmp    80105630 <alltraps>
...
8010645c:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106461:	e9 ca f1 ff ff       	jmp    80105630 <alltraps>
...
80106468:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010646d:	e9 be f1 ff ff       	jmp    80105630 <alltraps>
...
80106474:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106479:	e9 b2 f1 ff ff       	jmp    80105630 <alltraps>
...
80106480:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106485:	e9 a6 f1 ff ff       	jmp    80105630 <alltraps>
...
8010648c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106491:	e9 9a f1 ff ff       	jmp    80105630 <alltraps>
...
80106498:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010649d:	e9 8e f1 ff ff       	jmp    80105630 <alltraps>
...
801064a4:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801064a9:	e9 82 f1 ff ff       	jmp    80105630 <alltraps>
...
801064b0:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801064b5:	e9 76 f1 ff ff       	jmp    80105630 <alltraps>
...
801064bc:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801064c1:	e9 6a f1 ff ff       	jmp    80105630 <alltraps>
...
801064c8:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801064cd:	e9 5e f1 ff ff       	jmp    80105630 <alltraps>
...
801064d4:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801064d9:	e9 52 f1 ff ff       	jmp    80105630 <alltraps>
...
801064e0:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801064e5:	e9 46 f1 ff ff       	jmp    80105630 <alltraps>
...
801064ec:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801064f1:	e9 3a f1 ff ff       	jmp    80105630 <alltraps>
...
801064f8:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801064fd:	e9 2e f1 ff ff       	jmp    80105630 <alltraps>
...
80106504:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106509:	e9 22 f1 ff ff       	jmp    80105630 <alltraps>
...
80106510:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106515:	e9 16 f1 ff ff       	jmp    80105630 <alltraps>
...
8010651c:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106521:	e9 0a f1 ff ff       	jmp    80105630 <alltraps>
...
80106528:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010652d:	e9 fe f0 ff ff       	jmp    80105630 <alltraps>
...
80106534:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106539:	e9 f2 f0 ff ff       	jmp    80105630 <alltraps>
...
80106540:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106545:	e9 e6 f0 ff ff       	jmp    80105630 <alltraps>
...
8010654c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106551:	e9 da f0 ff ff       	jmp    80105630 <alltraps>
...
801065c2:	e8 29 de ff ff       	call   801043f0 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106661:	c3                   	ret    
  ...
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
80106662:	c7 04 24 80 78 10 80 	movl   $0x80107880,(%esp)
80106669:	e8 c2 9c ff ff       	call   80100330 <panic>
...
801066d8:	75 be                	jne    80106698 <deallocuvm.part.0+0x28>
      a += (NPTENTRIES - 1) * PGSIZE;
801066da:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
...
801066e6:	39 f3                	cmp    %esi,%ebx
801066e8:	72 e1                	jb     801066cb <deallocuvm.part.0+0x5b>
...
801066fa:	c3                   	ret    
    if(!pte)
      ...
      if(pa == 0)
        panic("kfree");
801066fb:	c7 04 24 d6 70 10 80 	movl   $0x801070d6,(%esp)
80106702:	e8 29 9c ff ff       	call   80100330 <panic>
...
80106728:	05 e0 12 11 80       	add    $0x801112e0,%eax
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
...
8010687b:	e8 70 db ff ff       	call   801043f0 <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
...
801068db:	a3 64 40 11 80       	mov    %eax,0x80114064
...
{
  lcr3(V2P(kpgdir));   // switch to the kernel page table
801068f0:	a1 64 40 11 80       	mov    0x80114064,%eax
...
80106917:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
8010691a:	e8 01 da ff ff       	call   80104320 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
8010691f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80106925:	b9 67 00 00 00       	mov    $0x67,%ecx
8010692a:	8d 50 08             	lea    0x8(%eax),%edx
8010692d:	66 89 88 a0 00 00 00 	mov    %cx,0xa0(%eax)
80106934:	89 d1                	mov    %edx,%ecx
80106936:	66 89 90 a2 00 00 00 	mov    %dx,0xa2(%eax)
8010693d:	c1 ea 18             	shr    $0x18,%edx
80106940:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
80106946:	ba 10 00 00 00       	mov    $0x10,%edx
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
8010694b:	c6 80 a6 00 00 00 40 	movb   $0x40,0xa6(%eax)
80106952:	c1 e9 10             	shr    $0x10,%ecx
  cpu->gdt[SEG_TSS].s = 0;
80106955:	c6 80 a5 00 00 00 89 	movb   $0x89,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
8010695c:	66 89 50 10          	mov    %dx,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80106960:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80106967:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
...
8010696d:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
{
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80106972:	8b 52 08             	mov    0x8(%edx),%edx
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  cpu->ts.iomb = (ushort) 0xFFFF;
80106975:	66 89 48 6e          	mov    %cx,0x6e(%eax)
{
  pushcli();
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
  cpu->gdt[SEG_TSS].s = 0;
  cpu->ts.ss0 = SEG_KDATA << 3;
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80106979:	81 c2 00 10 00 00    	add    $0x1000,%edx
8010697f:	89 50 0c             	mov    %edx,0xc(%eax)
}
...
80106982:	b8 30 00 00 00       	mov    $0x30,%eax
80106987:	0f 00 d8             	ltr    %ax
  ...
  ltr(SEG_TSS << 3);
  if(p->pgdir == 0)
8010698a:	8b 43 04             	mov    0x4(%ebx),%eax
8010698d:	85 c0                	test   %eax,%eax
8010698f:	74 12                	je     801069a3 <switchuvm+0x93>
...
{
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106996:	0f 22 d8             	mov    %eax,%cr3
  popcli();
}
80106999:	83 c4 14             	add    $0x14,%esp
8010699c:	5b                   	pop    %ebx
8010699d:	5d                   	pop    %ebp
  cpu->ts.iomb = (ushort) 0xFFFF;
  ltr(SEG_TSS << 3);
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
8010699e:	e9 ad d9 ff ff       	jmp    80104350 <popcli>
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  cpu->ts.iomb = (ushort) 0xFFFF;
  ltr(SEG_TSS << 3);
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
801069a3:	c7 04 24 86 78 10 80 	movl   $0x80107886,(%esp)
801069aa:	e8 81 99 ff ff       	call   80100330 <panic>
801069af:	90                   	nop
...
801069c8:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  ...
  if(sz >= PGSIZE)
801069cb:	77 54                	ja     80106a21 <inituvm+0x71>
    panic("inituvm: more than a page");
  mem = kalloc();
801069cd:	e8 be ba ff ff       	call   80102490 <kalloc>
  memset(mem, 0, PGSIZE);
801069d2:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801069d9:	00 
801069da:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801069e1:	00 
{
  char *mem;
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
  mem = kalloc();
801069e2:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
801069e4:	89 04 24             	mov    %eax,(%esp)
801069e7:	e8 04 da ff ff       	call   801043f0 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
801069ec:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801069f2:	b9 00 10 00 00       	mov    $0x1000,%ecx
801069f7:	89 04 24             	mov    %eax,(%esp)
801069fa:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801069fd:	31 d2                	xor    %edx,%edx
801069ff:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
80106a06:	00 
80106a07:	e8 e4 fb ff ff       	call   801065f0 <mappages>
  memmove(mem, init, sz);
80106a0c:	89 75 10             	mov    %esi,0x10(%ebp)
80106a0f:	89 7d 0c             	mov    %edi,0xc(%ebp)
80106a12:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
...
80106a1b:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106a1c:	e9 6f da ff ff       	jmp    80104490 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
80106a21:	c7 04 24 9a 78 10 80 	movl   $0x8010789a,(%esp)
80106a28:	e8 03 99 ff ff       	call   80100330 <panic>
...
80106a40:	0f 85 98 00 00 00    	jne    80106ade <loaduvm+0xae>
...
80106a4f:	eb 77                	jmp    80106ac8 <loaduvm+0x98>
...
80106a67:	76 5f                	jbe    80106ac8 <loaduvm+0x98>
...
80106a73:	e8 e8 fa ff ff       	call   80106560 <walkpgdir>
80106a78:	85 c0                	test   %eax,%eax
80106a7a:	74 56                	je     80106ad2 <loaduvm+0xa2>
...
80106a7c:	8b 00                	mov    (%eax),%eax
    if(sz - i < PGSIZE)
      ...
      n = PGSIZE;
80106a7e:	bf 00 10 00 00       	mov    $0x1000,%edi
80106a83:	8b 4d 14             	mov    0x14(%ebp),%ecx
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
...
80106a86:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
      ...
      n = PGSIZE;
80106a8b:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
80106a91:	0f 42 fe             	cmovb  %esi,%edi
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106a94:	05 00 00 00 80       	add    $0x80000000,%eax
80106a99:	89 44 24 04          	mov    %eax,0x4(%esp)
80106a9d:	8b 45 10             	mov    0x10(%ebp),%eax
80106aa0:	01 d9                	add    %ebx,%ecx
80106aa2:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80106aa6:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106aaa:	89 04 24             	mov    %eax,(%esp)
80106aad:	e8 8e ae ff ff       	call   80101940 <readi>
80106ab2:	39 f8                	cmp    %edi,%eax
80106ab4:	74 a2                	je     80106a58 <loaduvm+0x28>
      return -1;
  }
  return 0;
}
80106ab6:	83 c4 1c             	add    $0x1c,%esp
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
...
80106ac8:	83 c4 1c             	add    $0x1c,%esp
    else
      n = PGSIZE;
    if(readi(ip, P2V(pa), offset+i, n) != n)
      return -1;
...
80106ad1:	c3                   	ret    
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
80106ad2:	c7 04 24 b4 78 10 80 	movl   $0x801078b4,(%esp)
80106ad9:	e8 52 98 ff ff       	call   80100330 <panic>
{
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
80106ade:	c7 04 24 58 79 10 80 	movl   $0x80107958,(%esp)
80106ae5:	e8 46 98 ff ff       	call   80100330 <panic>
...
80106afe:	0f 88 7e 00 00 00    	js     80106b82 <allocuvm+0x92>
    return 0;
  if(newsz < oldsz)
...
80106b07:	8b 45 0c             	mov    0xc(%ebp),%eax
  ...
  if(newsz >= KERNBASE)
    return 0;
  if(newsz < oldsz)
80106b0a:	72 78                	jb     80106b84 <allocuvm+0x94>
    return oldsz;

  a = PGROUNDUP(oldsz);
80106b0c:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106b12:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
80106b18:	39 df                	cmp    %ebx,%edi
80106b1a:	77 4a                	ja     80106b66 <allocuvm+0x76>
80106b1c:	eb 72                	jmp    80106b90 <allocuvm+0xa0>
80106b1e:	66 90                	xchg   %ax,%ax
    ...
    memset(mem, 0, PGSIZE);
80106b20:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106b27:	00 
80106b28:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106b2f:	00 
80106b30:	89 04 24             	mov    %eax,(%esp)
80106b33:	e8 b8 d8 ff ff       	call   801043f0 <memset>
...
80106b49:	89 da                	mov    %ebx,%edx
80106b4b:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
80106b52:	00 
80106b53:	e8 98 fa ff ff       	call   801065f0 <mappages>
80106b58:	85 c0                	test   %eax,%eax
80106b5a:	78 44                	js     80106ba0 <allocuvm+0xb0>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
80106b5c:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106b62:	39 df                	cmp    %ebx,%edi
80106b64:	76 2a                	jbe    80106b90 <allocuvm+0xa0>
    mem = kalloc();
80106b66:	e8 25 b9 ff ff       	call   80102490 <kalloc>
    if(mem == 0){
...
80106b6d:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80106b6f:	75 af                	jne    80106b20 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
80106b71:	c7 04 24 d2 78 10 80 	movl   $0x801078d2,(%esp)
80106b78:	e8 a3 9a ff ff       	call   80100620 <cprintf>
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  pte_t *pte;
  uint a, pa;
  ...
  if(newsz >= oldsz)
80106b7d:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106b80:	77 48                	ja     80106bca <allocuvm+0xda>
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
...
80106b84:	83 c4 1c             	add    $0x1c,%esp
80106b87:	5b                   	pop    %ebx
80106b88:	5e                   	pop    %esi
80106b89:	5f                   	pop    %edi
80106b8a:	5d                   	pop    %ebp
...
80106b90:	83 c4 1c             	add    $0x1c,%esp
...
80106b9a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
80106ba0:	c7 04 24 ea 78 10 80 	movl   $0x801078ea,(%esp)
80106ba7:	e8 74 9a ff ff       	call   80100620 <cprintf>
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  pte_t *pte;
  uint a, pa;
  ...
  if(newsz >= oldsz)
80106bac:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106baf:	76 0d                	jbe    80106bbe <allocuvm+0xce>
80106bb1:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106bb4:	89 fa                	mov    %edi,%edx
...
80106bb9:	e8 b2 fa ff ff       	call   80106670 <deallocuvm.part.0>
    ...
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      ...
      deallocuvm(pgdir, newsz, oldsz);
      kfree(mem);
80106bbe:	89 34 24             	mov    %esi,(%esp)
80106bc1:	e8 1a b7 ff ff       	call   801022e0 <kfree>
      return 0;
80106bc6:	31 c0                	xor    %eax,%eax
80106bc8:	eb ba                	jmp    80106b84 <allocuvm+0x94>
80106bca:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106bcd:	89 fa                	mov    %edi,%edx
80106bcf:	8b 45 08             	mov    0x8(%ebp),%eax
80106bd2:	e8 99 fa ff ff       	call   80106670 <deallocuvm.part.0>
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
    if(mem == 0){
      cprintf("allocuvm out of memory\n");
...
80106bd9:	eb a9                	jmp    80106b84 <allocuvm+0x94>
80106bdb:	90                   	nop
...
80106bee:	73 08                	jae    80106bf8 <deallocuvm+0x18>
      kfree(v);
      *pte = 0;
    }
  }
...
80106bf0:	5d                   	pop    %ebp
80106bf1:	e9 7a fa ff ff       	jmp    80106670 <deallocuvm.part.0>
80106bf6:	66 90                	xchg   %ax,%ax
80106bf8:	89 d0                	mov    %edx,%eax
80106bfa:	5d                   	pop    %ebp
80106bfb:	c3                   	ret    
...
80106c08:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
80106c0b:	85 f6                	test   %esi,%esi
80106c0d:	74 59                	je     80106c68 <freevm+0x68>
80106c0f:	31 c9                	xor    %ecx,%ecx
80106c11:	ba 00 00 00 80       	mov    $0x80000000,%edx
80106c16:	89 f0                	mov    %esi,%eax
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80106c18:	31 db                	xor    %ebx,%ebx
80106c1a:	e8 51 fa ff ff       	call   80106670 <deallocuvm.part.0>
80106c1f:	eb 12                	jmp    80106c33 <freevm+0x33>
80106c21:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106c28:	83 c3 01             	add    $0x1,%ebx
80106c2b:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
80106c31:	74 27                	je     80106c5a <freevm+0x5a>
    if(pgdir[i] & PTE_P){
80106c33:	8b 14 9e             	mov    (%esi,%ebx,4),%edx
80106c36:	f6 c2 01             	test   $0x1,%dl
80106c39:	74 ed                	je     80106c28 <freevm+0x28>
      char * v = P2V(PTE_ADDR(pgdir[i]));
80106c3b:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80106c41:	83 c3 01             	add    $0x1,%ebx
    if(pgdir[i] & PTE_P){
      char * v = P2V(PTE_ADDR(pgdir[i]));
80106c44:	81 c2 00 00 00 80    	add    $0x80000000,%edx
      kfree(v);
80106c4a:	89 14 24             	mov    %edx,(%esp)
80106c4d:	e8 8e b6 ff ff       	call   801022e0 <kfree>
  uint i;
  ...
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80106c52:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
80106c58:	75 d9                	jne    80106c33 <freevm+0x33>
    if(pgdir[i] & PTE_P){
      char * v = P2V(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
80106c62:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80106c63:	e9 78 b6 ff ff       	jmp    801022e0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
  ...
  if(pgdir == 0)
    panic("freevm: no pgdir");
80106c68:	c7 04 24 06 79 10 80 	movl   $0x80107906,(%esp)
80106c6f:	e8 bc 96 ff ff       	call   80100330 <panic>
...
80106c9b:	c3                   	ret    
{
  ...
  if(pte == 0)
    panic("clearpteu");
80106c9c:	c7 04 24 17 79 10 80 	movl   $0x80107917,(%esp)
80106ca3:	e8 88 96 ff ff       	call   80100330 <panic>
80106ca8:	90                   	nop
...
80106cb6:	83 ec 2c             	sub    $0x2c,%esp
  ...
  if((d = setupkvm()) == 0)
80106cb9:	e8 92 fb ff ff       	call   80106850 <setupkvm>
...
80106d1b:	39 5d 0c             	cmp    %ebx,0xc(%ebp)
80106d1e:	76 50                	jbe    80106d70 <copyuvm+0xc0>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106d20:	8b 45 08             	mov    0x8(%ebp),%eax
80106d23:	31 c9                	xor    %ecx,%ecx
80106d25:	89 da                	mov    %ebx,%edx
80106d27:	e8 34 f8 ff ff       	call   80106560 <walkpgdir>
80106d2c:	85 c0                	test   %eax,%eax
80106d2e:	74 5b                	je     80106d8b <copyuvm+0xdb>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106d30:	8b 30                	mov    (%eax),%esi
80106d32:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106d38:	74 45                	je     80106d7f <copyuvm+0xcf>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106d3a:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106d3c:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106d42:	89 75 e4             	mov    %esi,-0x1c(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106d45:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106d4b:	e8 40 b7 ff ff       	call   80102490 <kalloc>
80106d50:	85 c0                	test   %eax,%eax
80106d52:	89 c6                	mov    %eax,%esi
80106d54:	75 82                	jne    80106cd8 <copyuvm+0x28>
      goto bad;
  }
  return d;
...
bad:
  freevm(d);
80106d56:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106d59:	89 04 24             	mov    %eax,(%esp)
80106d5c:	e8 9f fe ff ff       	call   80106c00 <freevm>
  return 0;
...
80106d7d:	eb e4                	jmp    80106d63 <copyuvm+0xb3>
  for(i = 0; i < sz; i += PGSIZE){
    ...
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
80106d7f:	c7 04 24 3b 79 10 80 	movl   $0x8010793b,(%esp)
80106d86:	e8 a5 95 ff ff       	call   80100330 <panic>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80106d8b:	c7 04 24 21 79 10 80 	movl   $0x80107921,(%esp)
80106d92:	e8 99 95 ff ff       	call   80100330 <panic>
...
80106e1c:	e8 6f d6 ff ff       	call   80104490 <memmove>
    len -= n;
    buf += n;
